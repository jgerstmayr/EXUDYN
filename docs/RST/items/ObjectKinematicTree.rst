...
* | **gravity** [type = Vector3D, default = [0.,0.,0.]]:
...
* | **baseOffset** [type = Vector3D, default = [0.,0.,0.]]:
  | offset vector for base, in global coordinates
* | **jointTypes** [type = JointTypeList, default = []]:
  | joint types of kinematic Tree joints; must be always set
* | **linkParents** [type = ArrayIndex, default = []]:
...
* | **jointTransformations** [type = Matrix3DList, default = []]:
...
* | **jointOffsets** [type = Vector3DList, default = []]:
...
* | **jointPositionOffsetVector** [type = Vector, default = []]:
...
* | **jointVelocityOffsetVector** [type = Vector, default = []]:
...
* | **jointPControlVector** [type = Vector, default = []]:
...
* | **jointDControlVector** [type = Vector, default = []]:
