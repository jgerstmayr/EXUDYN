...
.. _examples-ancfslidingjoint:

*******************
ANCFslidingJoint.py
*******************

You can view and download this file on Github: `ANCFslidingJoint.py <https://github.com/jgerstmayr/EXUDYN/tree/master/main/pythonDev/Examples/ANCFslidingJoint.py>`_
