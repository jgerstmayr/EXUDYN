...
+  Michael Pieber, University of Innsbruck (helped in several Python libraries; FEM and CMS testing; Abaqus import and test files; ANCFCable2D+ALE theory improvements and equations check)
