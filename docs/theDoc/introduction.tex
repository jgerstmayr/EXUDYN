...
%
\mysubsection{OpenVR} \label{sec:exudynOpenVR}
%
...
An example is provided in \texttt{engineOpenVR.py}, showing some optimal flags like locking the model rotation, zoom or translation.

Everything is experimental, but contributions are welcome!

\mysubsection{Interaction with other codes} \label{sec:interactionOtherCodes}
%
...
\mysubsection{ROS} \label{sec:exudynROS}
%
