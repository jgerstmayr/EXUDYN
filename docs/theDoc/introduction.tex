...
.. |picOverviewExudynModules| image:: docs/theDoc/figures/overviewExudynModules.png
   :width: 60%
...
Python parts\ignoreRST{, see Figs.\ \ref{fig_exudyn_CandPython}}.
\bi
  \item \mybold{C++ parts}\ignoreRST{, see Figs.\ \ref{fig_exudyn_CPP} and \ref{fig_system_overview}}:
  \bi
    \item[--] \texttt{exudyn}:
...
.. |picOverviewExudynCppModule| image:: docs/theDoc/figures/overviewExudynCppModule.png
   :width: 60%
...
\mysubsubsection{Visualization settings dialog}
...
\mysubsubsection{Storing the model view}
...
\item In the 'One cycle' mode, the player runs from the current position to the end; this is perfectly suited to record series of images for \mybold{creating animations}, see \refSection{secGeneratingAnimations} and works together with the visualization settings dialog.
\ei
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\mysubsection{Advanced topics} \label{sec:exudynAdvanced}
%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\mysubsubsection{OpenVR} \label{sec:exudynOpenVR}
%
The general open source libraries from Valve, see
\bi
\item[] https://github.com/ValveSoftware/openvr
\ei
have been linked to \codeName\ . In order to get OpenVR fully integrated, you need to run \texttt{setup.py} \codeName\ with the \texttt{--openvr} flag. For general installation instructions, see \refSection{sec:installationInstructions}.
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\mysubsubsection{Interaction with other codes} \label{sec:interactionOtherCodes}
%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\mysubsubsection{ROS} \label{sec:exudynROS}
%
