...
\acro{Rot}{rotation}
\acro{Rxyz}{rotation parameterization: consecutive rotations around x, y and z-axis (Tait-Bryan rotations)}
\acro{STL}{STereoLithography or Standard Triangle Language; file format available in nearly all CAD systems}
