...
\bi
  ...
  \item \texttt{exudyn.ComputeLinearizedSystem(...)}: computes the linearized system of equations and returns mass, stiffness, damping matrices (\mybold{coming SOON})
...
\bi
  ...
  \item \texttt{SensitivityAnalysis(...)}: compute sensitivities for certain parameters; works in parallel (\mybold{coming SOON})
\ei
