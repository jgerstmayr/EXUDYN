...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    saveImageFormat &     String &      &     'PNG' &     format for exporting figures: currently only PNG and TGA available; use TGA has highest compatibility with all platforms\\ \hline
