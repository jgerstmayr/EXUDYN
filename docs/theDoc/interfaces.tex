...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    exportVelocities &     bool &      &     True &     add \hac{ODE2} velocities to solution file\\ \hline
    exportAccelerations &     bool &      &     True &     add \hac{ODE2} accelerations to solution file\\ \hline
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    forODE2 &     bool &      &     False &     flag (true/false); false = perform direct computation (e.g., using autodiff) of jacobian for ODE2 equations, true = use numerical differentiation; as there must always exist an analytical implemented jacobian for AE, 'true' should only be used for verification\\ \hline
	  \end{longtable}
	\end{center}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    displayGlobalTimers &     bool &      &     False &     display global timer statistics at end of solving (e.g., for contact, but also for internal timings during development)\\ \hline
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    \hline
    \bf Name & \bf type / function return type & \bf size & \bf default value / function args & \bf description \\ \hline
    showSearchTree &     bool &      &     True &     show search tree of all GeneralContacts\\ \hline
    showBoundingBoxes &     bool &      &     True &     show bounding boxes of all GeneralContacts\\ \hline
    colorSearchTree &     Float4 &     4 &     [0.6,0.6,0.1,1.] &     \tabnewline cRGB color\\ \hline
    colorBoundingBoxes &     Float4 &     4 &     [0.6,0.6,0.1,1.] &     \tabnewline cRGB color\\ \hline
	  \end{longtable}
	\end{center}
