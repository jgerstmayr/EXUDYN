...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SolutionSettings}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    coordinatesSolutionFileName &     String &      &     'coordinatesSolution.txt' &     \tabnewline filename and (relative) path of solution file containing all coordinates versus time\\ \hline
    solverInformationFileName &     String &      &     'solverInormation.txt' &     \tabnewline filename and (relative) path of text file showing detailed information during solving; detail level according to yourSolver.verboseModeFile\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{NumericalDifferentiationSettings}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{NewtonSettings}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    modifiedNewtonJacUpdatePerStep &     bool &      &     False &     true: compute Jacobian at every time step, but not in every iteration (except for bad convergence ==> switch to full Newton)\\ \hline
    ...
    maxModifiedNewtonRestartIterations &     Index &      &     7 &     maximum number of iterations for modified Newton after aJacobian update; after that number of iterations, the full Newton method is started for this step\\ \hline
    ...
    ignoreMaxDiscontinuousIterations &     bool &      &     True &     continue solver if maximum number of discontinuous (post Newton) iterations is reached (ignore tolerance)\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{GeneralizedAlphaSettings}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    computeInitialAccelerations &     bool &      &     True &     true: compute initial accelerations from system EOM in acceleration form; false: use zero accelerations\\ \hline
	  \end{longtable}
	\end{center}

%+++++++++++++++++++++++++++++++++++
\mysubsubsection{TimeIntegrationSettings}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{StaticSolverSettings}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SimulationSettings}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsGeneral}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsWindow}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsOpenGL}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    initialModelRotation &     StdArray33F &     9 &     [Matrix3DF[3,3,1.,0.,0., 0.,1.,0., 0.,0.,1.]] &     \tabnewline initial model rotation matrix for OpenGl; in python use e.g.: initialModelRotation=[[1,0,0],[0,1,0],[0,0,1]]\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsContour}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    outputVariable &     OutputVariableType &      &     OutputVariableType::None &     \tabnewline selected contour plot output variable type; select OutputVariableType.None to deactivate contour plotting.\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsExportImages}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    saveImageFileName &     String &      &     'images/rame' &     filename (without extension!) and (relative) path for image file(s) with consecutive numbering (e.g., frame0000.tga, frame0001.tga,...); folders must already exist!\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsNodes}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsBeams}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsBodies}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    defaultColor &     Float4 &     4 &     [0.2,0.2,1.,1.] &     \tabnewline default cRGB olor for bodies; 4th value is \\ \hline
    beams &     VSettingsBeams &      &      &     visualization settings for beams (e.g. ANCFCable or other beam elements)\\ \hline
	  \end{longtable}
	\end{center}

%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsConnectors}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsMarkers}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VSettingsLoads}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{VisualizationSettings}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SolverLocalData}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SolverIterationData}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SolverConvergenceData}
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    discontinuousIterationsFailed &     bool &      &     False &     true, if discontinuous iterations failed (may be recovered if adaptive step is active)\\ \hline
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{SolverOutputData}
...
%+++++++++++++++++++++++++++++++++++
\mysubsubsection{MainSolverStatic}
PyBind interface (trampoline) class for CSolverStatic. With this interface, the static solver and its substructures can be accessed via python. NOTE that except from SolveSystem(...), these functions are only intended for experienced users and they need to be handled with care, as unexpected crashes may happen if used inappropriate. Furthermore, the functions have a lot of overhead (performance much lower than internal solver) due to python interfaces, and should thus be used for small systems.\\ 
%
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    InitializeSolverOutput &     void &      &     simulationSettings &     initialize output files; called from InitializeSolver()\\ \hline
    ...
    InitializeSolverInitialConditions &     void &      &     mainSystem, simulationSettings &     set/compute initial conditions (solver-specific!); called from InitializeSolver()\\ \hline
    ...
    ComputeJacobianODE2RHS\_t &     void &      &     mainSystem, scalarFactor=1. &     add jacobian of ODE2RHS\_t (multiplied with factor) to systemJacobian in cSolver\\ \hline
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    GetStartOfStepStateAAlgorithmic &     NumpyVector &      &      &     get locally stored / last computed algorithmic accelerations at start of step\\ \hline
    SetUserFunctionUpdateCurrentTime &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionInitializeStep &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionFinishStep &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionDiscontinuousIteration &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionNewton &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionComputeNewtonUpdate &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionComputeNewtonResidual &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    SetUserFunctionComputeNewtonJacobian &     void &      &     mainSystem, userFunction &     set user function\\ \hline
    GetSolverName &     std::string &      &      &     get solver name - needed for output file header and visualization window\\ \hline
    IsStaticSolver &     bool &      &      &     return true, if static solver; needs to be overwritten in derived class\\ \hline
    GetSimulationEndTime &     Real &      &     simulationSettings &     compute simulation end time (depends on static or time integration solver)\\ \hline
    ReduceStepSize &     bool &      &     mainSystem, simulationSettings, severity &     reduce step size (1..normal, 2..severe problems); return true, if reduction was successful\\ \hline
