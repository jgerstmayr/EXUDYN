...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    drawVerticalNumbers &     bool &      &     False &     show numbers at vertical lines; note that these numbers are interpolated values and may be different from values evaluated directly at this point!\\ \hline
