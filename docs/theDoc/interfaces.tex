...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    appendToFile &     bool &      &     False &     flag (true/false); if true, solution is appended to existing file (otherwise created)\\ \hline
    ...
    solverInformationFileName &     FileName &      &     'solverInormation.txt' &     \tabnewline filename and (relative) path of text file showing detailed information during solving; detail level according to yourSolver.verboseModeFile\\ \hline
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    saveImageFileName &     FileName &      &     'images/rame' &     filename (without extension!) and (relative) path for image file(s) with consecutive numbering (e.g., frame0000.tga, frame0001.tga,...); folders must already exist!\\ \hline
...
\begin{center}
  ...
  \begin{longtable}{| p{4.2cm} | p{2.5cm} | p{0.3cm} | p{3.0cm} | p{6cm} |}
    ...
    defaultSize &     float &      &     0.2 &     global sensor size; if -1.f, node size is relative to maxSceneSize\\ \hline
