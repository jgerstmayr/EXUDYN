...
\bi
  \item Joachim Sch{\"o}berl, TU Vienna (Providing specialized NGsolve core library with \texttt{taskmanager} for \mybold{multithreaded parallelization}; NGsolve mesh and FE-matrices import; highly efficient eigenvector computations)
