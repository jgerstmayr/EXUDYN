...
\ei
In some cases, your pre-built binary will not work due to some incompatibilities. Then you need to build from source as described in the Build and install sections, \refSection{sec:build:windows}.
...
\bi
  ...
  \item[] $\ra$ pre-built wheel: \texttt{exudyn-1.1.0-cp38-cp38-macosx\_11\_0\_x86\_64.whl}
\ei
\vspace{9pt}
