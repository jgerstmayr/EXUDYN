...
\bi
  \item Joachim Sch{\"o}berl (Providing specialized NGsolve core library with \texttt{taskmanager} for {\bf multithreaded parallelization}; NGsolve mesh and FE-matrices import; highly efficient eigenvector computations)
...
\bi
  \item Stefan Holzinger, Michael Pieber, Manuel Schieferle, Martin Knapp, Lukas March, 
  Dominik Sponring, David Wibmer, Andreas Zw{\"o}lfer, Peter Manzl
\ei
-- thanks a lot! --
%
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\ei
\vspace{9pt}
{\bf Compile from source}:\vspace{3pt}\\
...
\item[$\ra$] this \mybold{does not work} for beams with arbitrary rotation in reference configuration, e.g.,
