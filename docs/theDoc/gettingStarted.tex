...
How to cite:
\bi
  \item[] Johannes Gerstmayr. Exudyn -- A C++ based Python package for flexible multibody systems. Preprint, Research Square, 2023. \url{https://doi.org/10.21203/rs.3.rs-2693700/v1} \cite{Exudyn2023}
...
\bi
  \item J. Gerstmayr. Exudyn -- A C++ based Python package for flexible multibody systems. Preprint, Research Square, 2023. \ignoreRST{\cite{
  Exudyn2023}} \url{https://doi.org/10.21203/rs.3.rs-2693700/v1}
...
\bi
  ...
  \item Currently, we work with Python 3.6 - Python 3.11 \mybold{conda environments} on Windows, Linux and MacOS (3.8-3.10).
...
This is known for CentOS or simlilar systems which usually support manylinux2014. In this case, you have to build \codeName\ from source, see \refSection{sec:install:installinstructions:buildubuntu}.
