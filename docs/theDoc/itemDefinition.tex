...
\begin{center}
  ...
  \begin{longtable}{| p{4.5cm} | p{2.5cm} | p{0.5cm} | p{2.5cm} | p{6cm} |}
    ...
    jointTransformations &     Transformations66List &     \tabnewline  &     \tabnewline [] &     \tabnewline temporary list containing transformations (Pluecker transforms) per joint\\ \hline
    ...
    tempListT66 &     Transformations66List &     \tabnewline  &     \tabnewline [] &     \tabnewline temporary list of Pluecker transforms per link\\ \hline
...
\rowTable{forceUserFunction}{$\fv_{user} \in \Rcal^{n}$}{}
\rowTable{jointTransformations}{$\Xm \in \Rcal^{n \times (6 \times 6)}$}{}
\rowTable{linkInertiasT66}{$\Jm_{66} \in \Rcal^{n \times (6 \times 6)}$}{}
\rowTable{tempListT66}{$\in \Rcal^{n \times (6 \times 6)}$}{}
