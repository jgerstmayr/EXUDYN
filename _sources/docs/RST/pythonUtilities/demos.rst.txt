...
Relevant Examples (Ex) and TestModels (TM) with weblink to github:
    ...
    \ `xExudynConfigSpecial.py <https://github.com/jgerstmayr/EXUDYN/blob/master/main/pythonDev/Examples/xExudynConfigSpecial.py>`_\  (Ex), \ `allExudynModulesTest.py <https://github.com/jgerstmayr/EXUDYN/blob/master/main/pythonDev/TestModels/allExudynModulesTest.py>`_\  (TM)
...
Relevant Examples (Ex) and TestModels (TM) with weblink to github:
    ...
    \ `allExudynModulesTest.py <https://github.com/jgerstmayr/EXUDYN/blob/master/main/pythonDev/TestModels/allExudynModulesTest.py>`_\  (TM)
