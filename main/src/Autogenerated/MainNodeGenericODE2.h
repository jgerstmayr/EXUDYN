...
public: // AUTO: 
    ...
    virtual py::dict GetDictionary() const override
    {
        ...
        d["referenceCoordinates"] = EPyUtils::Vector2NumPy(cNodeGenericODE2->GetParameters().referenceCoordinates); //! AUTO: cast variables into python (not needed for standard types) 
        ...
        d["initialCoordinates_t"] = EPyUtils::Vector2NumPy(GetParameters().initialCoordinates_t); //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("referenceCoordinates") == 0) { return EPyUtils::Vector2NumPy(cNodeGenericODE2->GetParameters().referenceCoordinates);} //! AUTO: get parameter
        ...
        else if (parameterName.compare("initialCoordinates_t") == 0) { return EPyUtils::Vector2NumPy(GetParameters().initialCoordinates_t);} //! AUTO: get parameter
