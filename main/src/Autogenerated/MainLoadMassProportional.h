...
public: // AUTO: 
    ...
    virtual void SetWithDictionary(const py::dict& d) override
    {
        ...
        HPyUtils::SetVector3DSafely(d, "loadVector", cLoadMassProportional->GetParameters().loadVector); /*! AUTO:  safely cast to C++ type*/
        if (HPyUtils::DictItemExists(d, "loadVectorUserFunction")) { if (HPyUtils::CheckForValidFunction(d["loadVectorUserFunction"])) { cLoadMassProportional->GetParameters().loadVectorUserFunction = py::cast<std::function<StdVector3D(Real,StdVector3D)>>((py::function)d["loadVectorUserFunction"]); /* AUTO:  read out dictionary and cast to C++ type*/}} 
        HPyUtils::SetStringSafely(d, "name", name); /*! AUTO:  safely cast to C++ type*/
        if (HPyUtils::DictItemExists(d, "Vshow")) { visualizationLoadMassProportional->GetShow() = py::cast<bool>(d["Vshow"]); /* AUTO:  read out dictionary and cast to C++ type*/} 
    }
    ...
    virtual py::dict GetDictionary() const override
    {
        ...
        d["loadVectorUserFunction"] = (std::function<StdVector3D(Real,StdVector3D)>)cLoadMassProportional->GetParameters().loadVectorUserFunction; //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("loadVectorUserFunction") == 0) { return py::cast((std::function<StdVector3D(Real,StdVector3D)>)cLoadMassProportional->GetParameters().loadVectorUserFunction);} //! AUTO: get parameter
    ...
    virtual void SetParameter(const STDstring& parameterName, const py::object& value) override 
    {
        ...
        else if (parameterName.compare("loadVector") == 0) { HPyUtils::SetVector3DSafely(value, cLoadMassProportional->GetParameters().loadVector); /*! AUTO:  safely cast to C++ type*/; } //! AUTO: get parameter
        else if (parameterName.compare("loadVectorUserFunction") == 0) { cLoadMassProportional->GetParameters().loadVectorUserFunction = py::cast<std::function<StdVector3D(Real,StdVector3D)>>(value); /* AUTO:  read out dictionary and cast to C++ type*/; } //! AUTO: get parameter
