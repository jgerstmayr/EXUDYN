...
// AUTO:  ++++++++++++++++++++++
    ...
    py::class_<MainSolverStatic>(m, "MainSolverStatic") // AUTO: 
        ...
        .def("InitializeSolverOutput", &MainSolverStatic::InitializeSolverOutput, "initialize output files; called from InitializeSolver()", py::arg("simulationSettings"))
    ...
    py::class_<MainSolverImplicitSecondOrder>(m, "MainSolverImplicitSecondOrder") // AUTO: 
        ...
        .def("InitializeSolverOutput", &MainSolverImplicitSecondOrder::InitializeSolverOutput, "initialize output files; called from InitializeSolver()", py::arg("simulationSettings"))
