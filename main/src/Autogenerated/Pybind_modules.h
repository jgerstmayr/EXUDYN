...
// AUTO:  ++++++++++++++++++++++
    ...
    py::class_<SolutionSettings>(m, "SolutionSettings") // AUTO: 
        ...
        .def_readwrite("exportODE1Velocities", &SolutionSettings::exportODE1Velocities)
    ...
    py::class_<NumericalDifferentiationSettings>(m, "NumericalDifferentiationSettings") // AUTO: 
        ...
        .def_readwrite("forAE", &NumericalDifferentiationSettings::forAE)
        .def_readwrite("forODE2", &NumericalDifferentiationSettings::forODE2)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<DiscontinuousSettings>(m, "DiscontinuousSettings") // AUTO: 
        .def(py::init<>())
        .def_property("maxIterations", &DiscontinuousSettings::PyGetMaxIterations, &DiscontinuousSettings::PySetMaxIterations)
        .def_readwrite("ignoreMaxIterations", &DiscontinuousSettings::ignoreMaxIterations)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<ExplicitIntegrationSettings>(m, "ExplicitIntegrationSettings") // AUTO: 
        .def(py::init<>())
        .def_readwrite("eliminateConstraints", &ExplicitIntegrationSettings::eliminateConstraints)
        .def_readwrite("useLieGroupIntegration", &ExplicitIntegrationSettings::useLieGroupIntegration)
        .def_readwrite("dynamicSolverType", &ExplicitIntegrationSettings::dynamicSolverType)
    ...
    py::class_<TimeIntegrationSettings>(m, "TimeIntegrationSettings") // AUTO: 
        ...
        .def_readwrite("discontinuous", &TimeIntegrationSettings::discontinuous)
        ...
        .def_readwrite("automaticStepSize", &TimeIntegrationSettings::automaticStepSize)
        ...
        .def_readwrite("reuseConstantMassMatrix", &TimeIntegrationSettings::reuseConstantMassMatrix)
        .def_readwrite("preStepPyExecute", &TimeIntegrationSettings::preStepPyExecute)
        .def_readwrite("simulateInRealtime", &TimeIntegrationSettings::simulateInRealtime)
        ...
        .def_readwrite("explicitIntegration", &TimeIntegrationSettings::explicitIntegration)
    ...
    py::class_<StaticSolverSettings>(m, "StaticSolverSettings") // AUTO: 
        ...
        .def_readwrite("discontinuous", &StaticSolverSettings::discontinuous)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<LinearSolverSettings>(m, "LinearSolverSettings") // AUTO: 
        .def(py::init<>())
        .def_property("pivotTreshold", &LinearSolverSettings::PyGetPivotTreshold, &LinearSolverSettings::PySetPivotTreshold)
        .def_readwrite("ignoreRedundantConstraints", &LinearSolverSettings::ignoreRedundantConstraints)
        .def_readwrite("ignoreSingularJacobian", &LinearSolverSettings::ignoreSingularJacobian)
        .def_readwrite("showCausingItems", &LinearSolverSettings::showCausingItems)
    ...
    py::class_<SimulationSettings>(m, "SimulationSettings") // AUTO: 
        ...
        .def_readwrite("linearSolverSettings", &SimulationSettings::linearSolverSettings)
        ...
        .def_readwrite("displayGlobalTimers", &SimulationSettings::displayGlobalTimers)
        ...
        .def_property("numberOfThreads", &SimulationSettings::PyGetNumberOfThreads, &SimulationSettings::PySetNumberOfThreads)
    ...
    py::class_<VSettingsGeneral>(m, "VSettingsGeneral") // AUTO: 
        ...
        .def_readwrite("useWindowsMonitorScaleFactor", &VSettingsGeneral::useWindowsMonitorScaleFactor)
        .def_readwrite("useBitmapText", &VSettingsGeneral::useBitmapText)
        ...
        .def_readwrite("useGradientBackground", &VSettingsGeneral::useGradientBackground)
        ...
        .def_readwrite("drawWorldBasis", &VSettingsGeneral::drawWorldBasis)
        .def_readwrite("worldBasisSize", &VSettingsGeneral::worldBasisSize)
        ...
        .def_readwrite("showSolutionInformation", &VSettingsGeneral::showSolutionInformation)
        .def_readwrite("showSolverInformation", &VSettingsGeneral::showSolverInformation)
        .def_readwrite("showSolverTime", &VSettingsGeneral::showSolverTime)
        .def_readwrite("renderWindowString", &VSettingsGeneral::renderWindowString)
    ...
    py::class_<VSettingsContour>(m, "VSettingsContour") // AUTO: 
        ...
        .def_readwrite("reduceRange", &VSettingsContour::reduceRange)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<VSettingsContact>(m, "VSettingsContact") // AUTO: 
        .def(py::init<>())
        .def_readwrite("showSearchTree", &VSettingsContact::showSearchTree)
        .def_readwrite("showBoundingBoxes", &VSettingsContact::showBoundingBoxes)
    ...
    py::class_<VSettingsWindow>(m, "VSettingsWindow") // AUTO: 
        ...
        .def_readwrite("keyPressUserFunction", &VSettingsWindow::keyPressUserFunction)
        .def_readwrite("showMouseCoordinates", &VSettingsWindow::showMouseCoordinates)
        .def_readwrite("ignoreKeys", &VSettingsWindow::ignoreKeys)
    ...
    py::class_<VSettingsOpenGL>(m, "VSettingsOpenGL") // AUTO: 
        ...
        .def_readwrite("facesTransparent", &VSettingsOpenGL::facesTransparent)
        ...
        .def_readwrite("enableLighting", &VSettingsOpenGL::enableLighting)
        .def_readwrite("lightModelLocalViewer", &VSettingsOpenGL::lightModelLocalViewer)
        .def_readwrite("lightModelTwoSide", &VSettingsOpenGL::lightModelTwoSide)
        ...
        .def_readwrite("light0constantAttenuation", &VSettingsOpenGL::light0constantAttenuation)
        .def_readwrite("light0linearAttenuation", &VSettingsOpenGL::light0linearAttenuation)
        .def_readwrite("light0quadraticAttenuation", &VSettingsOpenGL::light0quadraticAttenuation)
        ...
        .def_readwrite("light1constantAttenuation", &VSettingsOpenGL::light1constantAttenuation)
        .def_readwrite("light1linearAttenuation", &VSettingsOpenGL::light1linearAttenuation)
        .def_readwrite("light1quadraticAttenuation", &VSettingsOpenGL::light1quadraticAttenuation)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<VSettingsInteractive>(m, "VSettingsInteractive") // AUTO: 
        .def(py::init<>())
        .def_readwrite("keypressRotationStep", &VSettingsInteractive::keypressRotationStep)
        .def_readwrite("mouseMoveRotationFactor", &VSettingsInteractive::mouseMoveRotationFactor)
        .def_readwrite("keypressTranslationStep", &VSettingsInteractive::keypressTranslationStep)
        .def_readwrite("zoomStepFactor", &VSettingsInteractive::zoomStepFactor)
        .def_readwrite("highlightItemIndex", &VSettingsInteractive::highlightItemIndex)
        .def_readwrite("highlightItemType", &VSettingsInteractive::highlightItemType)
        ...
        .def_readwrite("selectionLeftMouse", &VSettingsInteractive::selectionLeftMouse)
        .def_readwrite("selectionRightMouse", &VSettingsInteractive::selectionRightMouse)
    ...
    py::class_<VisualizationSettings>(m, "VisualizationSettings") // AUTO: 
        ...
        .def_readwrite("contact", &VisualizationSettings::contact)
        .def_readwrite("window", &VisualizationSettings::window)
        .def_readwrite("openGL", &VisualizationSettings::openGL)
        .def_readwrite("interactive", &VisualizationSettings::interactive)
    ...
    py::class_<CSolverTimer>(m, "CSolverTimer") // AUTO: 
        ...
        .def_readwrite("ODE1RHS", &CSolverTimer::ODE1RHS)
        .def_readwrite("AERHS", &CSolverTimer::AERHS)
        .def_readwrite("totalJacobian", &CSolverTimer::totalJacobian)
        .def_readwrite("jacobianODE1", &CSolverTimer::jacobianODE1)
        ...
        .def_readwrite("errorEstimator", &CSolverTimer::errorEstimator)
    ...
    py::class_<SolverLocalData>(m, "SolverLocalData") // AUTO: 
        ...
        .def_readwrite("tempODE1F0", &SolverLocalData::tempODE1F0)
        .def_readwrite("tempODE1F1", &SolverLocalData::tempODE1F1)
    ...
    py::class_<SolverIterationData>(m, "SolverIterationData") // AUTO: 
        ...
        .def_readwrite("initialStepSize", &SolverIterationData::initialStepSize)
        .def_readwrite("lastStepSize", &SolverIterationData::lastStepSize)
        .def_readwrite("currentStepSize", &SolverIterationData::currentStepSize)
        .def_readwrite("recommendedStepSize", &SolverIterationData::recommendedStepSize)
        ...
        .def_readwrite("automaticStepSize", &SolverIterationData::automaticStepSize)
        ...
        .def_readwrite("rejectedAutomaticStepSizeSteps", &SolverIterationData::rejectedAutomaticStepSizeSteps)
        .def_readwrite("automaticStepSizeError", &SolverIterationData::automaticStepSizeError)
    ...
    py::class_<SolverConvergenceData>(m, "SolverConvergenceData") // AUTO: 
        ...
        .def_readwrite("discontinuousIterationSuccessful", &SolverConvergenceData::discontinuousIterationSuccessful)
        .def_readwrite("linearSolverFailed", &SolverConvergenceData::linearSolverFailed)
        .def_readwrite("linearSolverCausingRow", &SolverConvergenceData::linearSolverCausingRow)
    ...
    py::class_<SolverOutputData>(m, "SolverOutputData") // AUTO: 
        ...
        .def_readwrite("stepInformation", &SolverOutputData::stepInformation)
    ...
    //++++++++++++++++++++++++++++++++
    //++++++++++++++++++++++++++++++++
    py::class_<MainSolverExplicit>(m, "MainSolverExplicit") // AUTO: 
        .def(py::init<>())
