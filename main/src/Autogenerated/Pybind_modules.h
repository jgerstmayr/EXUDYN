...
// AUTO:  ++++++++++++++++++++++
    ...
    py::class_<VSettingsOpenVR>(m, "VSettingsOpenVR", "VSettingsOpenVR class") // AUTO: 
        .def(py::init<>())
        .def_readwrite("enableOpenVR", &VSettingsOpenVR::enableOpenVR, "True: openVR enabled (if compiled with according flag and installed openVR)")
