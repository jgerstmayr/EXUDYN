...
// AUTO:  ++++++++++++++++++++++
    ...
    py::class_<VSettingsInteractive>(m, "VSettingsInteractive", "VSettingsInteractive class") // AUTO: 
        ...
        .def_readwrite("lockModelView", &VSettingsInteractive::lockModelView, "True: all movements (with mouse/keys), rotations, zoom are disabled; initial values are considered")
