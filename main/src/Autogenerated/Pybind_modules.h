...
// AUTO:  ++++++++++++++++++++++
    ...
    py::class_<DiscontinuousSettings>(m, "DiscontinuousSettings") // AUTO: 
        .def(py::init<>())
        .def_readwrite("maxIterations", &DiscontinuousSettings::maxIterations)
        .def_readwrite("ignoreMaxIterations", &DiscontinuousSettings::ignoreMaxIterations)
        .def_readwrite("iterationTolerance", &DiscontinuousSettings::iterationTolerance)
    ...
    py::class_<TimeIntegrationSettings>(m, "TimeIntegrationSettings") // AUTO: 
        ...
        .def_readwrite("initialStepSize", &TimeIntegrationSettings::initialStepSize)
        .def_readwrite("absoluteTolerance", &TimeIntegrationSettings::absoluteTolerance)
        .def_readwrite("relativeTolerance", &TimeIntegrationSettings::relativeTolerance)
        .def_readwrite("stepSizeSafety", &TimeIntegrationSettings::stepSizeSafety)
        .def_readwrite("stepSizeMaxIncrease", &TimeIntegrationSettings::stepSizeMaxIncrease)
        ...
        .def_readwrite("realtimeFactor", &TimeIntegrationSettings::realtimeFactor)
        ...
        .def_readwrite("stepInformation", &TimeIntegrationSettings::stepInformation)
    ...
    py::class_<StaticSolverSettings>(m, "StaticSolverSettings") // AUTO: 
        ...
        .def_readwrite("stepInformation", &StaticSolverSettings::stepInformation)
    ...
    py::class_<MainSolverImplicitSecondOrder>(m, "MainSolverImplicitSecondOrder") // AUTO: 
        ...
        .def_readwrite("useOldAccBasedSolver", &MainSolverImplicitSecondOrder::useOldAccBasedSolver)
