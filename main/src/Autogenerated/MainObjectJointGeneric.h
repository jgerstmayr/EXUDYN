...
public: // AUTO: 
    ...
    {
        cObjectJointGeneric->GetParameters().markerNumbers = py::cast<std::vector<Index>>(d["markerNumbers"]); /* AUTO:  read out dictionary and cast to C++ type*/
        ...
        if (EPyUtils::DictItemExists(d, "offsetUserFunction")) { if (EPyUtils::CheckForValidFunction(d["offsetUserFunction"])) { cObjectJointGeneric->GetParameters().offsetUserFunction = py::cast<std::function<StdVector(Real,StdVector6D)>>((py::function)d["offsetUserFunction"]); /* AUTO:  read out dictionary and cast to C++ type*/}} 
        if (EPyUtils::DictItemExists(d, "offsetUserFunction_t")) { if (EPyUtils::CheckForValidFunction(d["offsetUserFunction_t"])) { cObjectJointGeneric->GetParameters().offsetUserFunction_t = py::cast<std::function<StdVector(Real,StdVector6D)>>((py::function)d["offsetUserFunction_t"]); /* AUTO:  read out dictionary and cast to C++ type*/}} 
 ...
 //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("offsetUserFunction") == 0) { return py::cast((std::function<StdVector(Real,StdVector6D)>)cObjectJointGeneric->GetParameters().offsetUserFunction);} //! AUTO: get parameter
        else if (parameterName.compare("offsetUserFunction_t") == 0) { return py::cast((std::function<StdVector(Real,StdVector6D)>)cObjectJointGeneric->GetParameters().offsetUserFunction_t);} //! AUTO: get parameter
    ...
    virtual void SetParameter(const STDstring& parameterName, const py::object& value) override 
    {
        ...
        else if (parameterName.compare("markerNumbers") == 0) { cObjectJointGeneric->GetParameters().markerNumbers = py::cast<std::vector<Index>>(value); /* AUTO:  read out dictionary and cast to C++ type*/; } //! AUTO: get parameter
        ...
        else if (parameterName.compare("offsetUserFunction") == 0) { cObjectJointGeneric->GetParameters().offsetUserFunction = py::cast<std::function<StdVector(Real,StdVector6D)>>(value); /* AUTO:  read out dictionary and cast to C++ type*/; } //! AUTO: get parameter
        else if (parameterName.compare("offsetUserFunction_t") == 0) { cObjectJointGeneric->GetParameters().offsetUserFunction_t = py::cast<std::function<StdVector(Real,StdVector6D)>>(value); /* AUTO:  read out dictionary and cast to C++ type*/; } //! AUTO: get parameter
