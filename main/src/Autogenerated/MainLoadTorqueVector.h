...
public: // AUTO: 
    ...
    virtual void SetWithDictionary(const py::dict& d) override
    {
        ...
        HPyUtils::SetVector3DSafely(d, "loadVector", cLoadTorqueVector->GetParameters().loadVector); /*! AUTO:  safely cast to C++ type*/
        if (HPyUtils::DictItemExists(d, "loadVectorUserFunction")) { if (HPyUtils::CheckForValidFunction(d["loadVectorUserFunction"])) { cLoadTorqueVector->GetParameters().loadVectorUserFunction = py::cast<std::function<StdVector3D(Real,StdVector3D)>>((py::function)d["loadVectorUserFunction"]); /* AUTO:  read out dictionary and cast to C++ type*/}} 
        HPyUtils::SetStringSafely(d, "name", name); /*! AUTO:  safely cast to C++ type*/
        if (HPyUtils::DictItemExists(d, "Vshow")) { visualizationLoadTorqueVector->GetShow() = py::cast<bool>(d["Vshow"]); /* AUTO:  read out dictionary and cast to C++ type*/} 
    }
    ...
    virtual void SetParameter(const STDstring& parameterName, const py::object& value) override 
    {
        ...
        else if (parameterName.compare("loadVector") == 0) { HPyUtils::SetVector3DSafely(value, cLoadTorqueVector->GetParameters().loadVector); /*! AUTO:  safely cast to C++ type*/; } //! AUTO: get parameter
