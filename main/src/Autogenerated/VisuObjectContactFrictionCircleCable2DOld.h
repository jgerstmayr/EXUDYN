/** ***********************************************************************************************
* @class        VisualizationObjectContactFrictionCircleCable2DOld
...
* @date         2022-03-02  09:22:21 (last modified)
*
...
#ifndef VISUALIZATIONOBJECTCONTACTFRICTIONCIRCLECABLE2DOLD__H
#define VISUALIZATIONOBJECTCONTACTFRICTIONCIRCLECABLE2DOLD__H
...
class VisualizationObjectContactFrictionCircleCable2DOld: public VisualizationObject // AUTO: 
{
protected: // AUTO: 
...
public: // AUTO: 
    ...
    VisualizationObjectContactFrictionCircleCable2DOld()
    {
        show = true;
        drawSize = -1.f;
