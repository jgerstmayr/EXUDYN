...
* @date         2021-01-04  23:07:49 (last modfied)
*
...
public: // AUTO: 
    ...
    virtual void SetWithDictionary(const py::dict& d) override
    {
        ...
        if (EPyUtils::DictItemExists(d, "springForceUserFunction")) { if (EPyUtils::CheckForValidFunction(d["springForceUserFunction"])) 
            { cObjectConnectorCoordinateSpringDamper->GetParameters().springForceUserFunction = py::cast<std::function<Real(const MainSystem&,Real,Real,Real,Real,Real,Real,Real,Real)>>((py::function)d["springForceUserFunction"]); /* AUTO:  read out dictionary and cast to C++ type*/}
    ...
    virtual py::dict GetDictionary() const override
    {
        ...
        if (cObjectConnectorCoordinateSpringDamper->GetParameters().springForceUserFunction)
            {d["springForceUserFunction"] = (std::function<Real(const MainSystem&,Real,Real,Real,Real,Real,Real,Real,Real)>)cObjectConnectorCoordinateSpringDamper->GetParameters().springForceUserFunction;}
        else
 ...
 //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("springForceUserFunction") == 0) { return py::cast((std::function<Real(const MainSystem&,Real,Real,Real,Real,Real,Real,Real,Real)>)cObjectConnectorCoordinateSpringDamper->GetParameters().springForceUserFunction);} //! AUTO: get parameter
    ...
    virtual void SetParameter(const STDstring& parameterName, const py::object& value) override 
    {
        ...
        else if (parameterName.compare("springForceUserFunction") == 0) { if (py::isinstance<py::function>(value)) {cObjectConnectorCoordinateSpringDamper->GetParameters().springForceUserFunction = py::cast<std::function<Real(const MainSystem&,Real,Real,Real,Real,Real,Real,Real,Real)>>(value); /* AUTO:  read out dictionary and cast to C++ type*/} else
