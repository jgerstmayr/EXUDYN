/** ***********************************************************************************************
* @class        CNodeRigidBodyRotVecDataLGParameters
* @brief        Parameter class for CNodeRigidBodyRotVecDataLG
*
* @author       Gerstmayr Johannes, Holzinger Stefan
* @date         2019-07-01 (generated)
* @date         2022-08-26  11:29:45 (last modified)
*
...
#ifndef CNODERIGIDBODYROTVECDATALGPARAMETERS__H
#define CNODERIGIDBODYROTVECDATALGPARAMETERS__H
...
//! AUTO: Parameters for class CNodeRigidBodyRotVecDataLGParameters
class CNodeRigidBodyRotVecDataLGParameters // AUTO: 
{
public: // AUTO: 
    ...
    CNodeRigidBodyRotVecDataLGParameters()
    {
...
/** ***********************************************************************************************
* @class        CNodeRigidBodyRotVecDataLG
...
//! AUTO: CNodeRigidBodyRotVecDataLG
class CNodeRigidBodyRotVecDataLG: public CNodeRigidBody // AUTO: 
{
protected: // AUTO: 
    ...
    CNodeRigidBodyRotVecDataLGParameters parameters; //! AUTO: contains all parameters for CNodeRigidBodyRotVecDataLG

public: // AUTO: 

    // AUTO: access functions
    //! AUTO: Write (Reference) access to parameters
    virtual CNodeRigidBodyRotVecDataLGParameters& GetParameters() { return parameters; }
    //! AUTO: Read access to parameters
    virtual const CNodeRigidBodyRotVecDataLGParameters& GetParameters() const { return parameters; }
    ...
    //! AUTO:  this function is needed additionally, because Node is derived only from NodeODE2
    virtual void SetGlobalDataCoordinateIndex(Index globalIndex) override
    {
        globalDataCoordinateIndex = globalIndex;
    }

    //! AUTO:  this function is needed additionally, because Node is derived only from NodeODE2
    virtual Index GetGlobalDataCoordinateIndex() const override
    {
    ...
    //! AUTO:  this function is needed additionally, because Node is derived only from NodeODE2
    template<class TVector> void GetCurrentAndReferenceODE2CoordinateVector(TVector& vector) const
    {
        vector.CopyFrom(LinkedDataVector(computationalData->currentState.dataCoords, globalDataCoordinateIndex, GetNumberOfDataCoordinates()));
    }

    //! AUTO:  this function is needed additionally, because Node is derived only from NodeODE2
    template<class TVector> void GetODE2CoordinateVectorWithReference(TVector& vector, ConfigurationType configuration = ConfigurationType::Current) const
    {
        if (configuration != ConfigurationType::Reference) { vector = GetCoordinateVector(configuration); } else { vector.CopyFrom(GetReferenceCoordinateVector()); }
    }
    ...
    {
        return (Node::Type)(Node::Position + Node::Orientation + Node::RigidBody + Node::RotationRotationVector + Node::LieGroupWithDataCoordinates);
    }

    //! AUTO:  return node group, which is special because of algebraic equations
    virtual CNodeGroup GetNodeGroup() const override
    {
        return (CNodeGroup)((Index)CNodeGroup::ODE2variables + (Index)CNodeGroup::DataVariables);
    }
