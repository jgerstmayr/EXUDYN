/** ***********************************************************************************************
* @class        VisualizationObjectConnectorCoordinate
...
#ifndef VISUALIZATIONOBJECTCONNECTORCOORDINATE__H
#define VISUALIZATIONOBJECTCONNECTORCOORDINATE__H
...
class VisualizationObjectConnectorCoordinate: public VisualizationObject // AUTO: 
{
protected: // AUTO: 
...
public: // AUTO: 
    ...
    VisualizationObjectConnectorCoordinate()
    {
        show = true;
        drawSize = -1.f;
