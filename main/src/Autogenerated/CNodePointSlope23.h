/** ***********************************************************************************************
* @class        CNodePointSlope23Parameters
* @brief        Parameter class for CNodePointSlope23
*
...
#ifndef CNODEPOINTSLOPE23PARAMETERS__H
#define CNODEPOINTSLOPE23PARAMETERS__H
...
//! AUTO: Parameters for class CNodePointSlope23Parameters
class CNodePointSlope23Parameters // AUTO: 
{
public: // AUTO: 
...
//! AUTO: CNodePointSlope23
class CNodePointSlope23: public CNodeODE2 // AUTO: 
{
protected: // AUTO: 
    CNodePointSlope23Parameters parameters; //! AUTO: contains all parameters for CNodePointSlope23
...
public: // AUTO: 
    ...
    virtual CNodePointSlope23Parameters& GetParameters() { return parameters; }
    //! AUTO: Read access to parameters
    virtual const CNodePointSlope23Parameters& GetParameters() const { return parameters; }
    ...
    //! AUTO:  provide 'rotation' jacobian \f$\Jm_R\f$ of node; derivative of 3D angular velocity with respect to all nodal velocity coordinates; action of torque: \f$\Qm_m = \Jm_R^T \mv\f$
