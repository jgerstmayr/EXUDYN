/** ***********************************************************************************************
* @class        CObjectJointRevoluteParameters
* @brief        Parameter class for CObjectJointRevolute
*
...
#ifndef COBJECTJOINTREVOLUTEPARAMETERS__H
#define COBJECTJOINTREVOLUTEPARAMETERS__H
...
//! AUTO: Parameters for class CObjectJointRevoluteParameters
class CObjectJointRevoluteParameters // AUTO: 
{
public: // AUTO: 
    ...
    CObjectJointRevoluteParameters()
    {
...
//! AUTO: CObjectJointRevolute
class CObjectJointRevolute: public CObjectConstraint // AUTO: 
{
protected: // AUTO: 
    static constexpr Index nConstraints = 5;
    CObjectJointRevoluteParameters parameters; //! AUTO: contains all parameters for CObjectJointRevolute

public: // AUTO: 

    // AUTO: access functions
    //! AUTO: Write (Reference) access to parameters
    virtual CObjectJointRevoluteParameters& GetParameters() { return parameters; }
    //! AUTO: Read access to parameters
    virtual const CObjectJointRevoluteParameters& GetParameters() const { return parameters; }
