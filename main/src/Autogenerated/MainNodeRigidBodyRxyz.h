...
public: // AUTO: 
    ...
    virtual py::dict GetDictionary() const override
    {
        ...
        d["referenceCoordinates"] = EPyUtils::SlimVector2NumPy(cNodeRigidBodyRxyz->GetParameters().referenceCoordinates); //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("referenceCoordinates") == 0) { return EPyUtils::SlimVector2NumPy(cNodeRigidBodyRxyz->GetParameters().referenceCoordinates);} //! AUTO: get parameter
