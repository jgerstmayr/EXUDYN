...
public: // AUTO: 
    ...
    virtual py::dict GetDictionary() const override
    {
        ...
        d["markerNumbers"] = (std::vector<Index>)cObjectConnectorDistance->GetParameters().markerNumbers; //! AUTO: cast variables into python (not needed for standard types) 
    ...
    virtual py::object GetParameter(const STDstring& parameterName) const override 
    {
        ...
        else if (parameterName.compare("markerNumbers") == 0) { return py::cast((std::vector<Index>)cObjectConnectorDistance->GetParameters().markerNumbers);} //! AUTO: get parameter
