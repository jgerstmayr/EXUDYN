...
public: // AUTO: 
    ...
    ArrayIndex nodeNumbers;                       //!< AUTO: node number of GenericODE1 node for hydraulic components (reference values for this node must be zero); data node may be added in future
    ...
    Real referenceVolume0;                        //!< AUTO: chamber reference volume [SI:m\f$^3\f$] at piston head (nut) side (0) for stroke length zero
    Real referenceVolume1;                        //!< AUTO: chamber reference volume [SI:m\f$^2\f$] at piston rod side (1) for stroke length zero
