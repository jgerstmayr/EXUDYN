/** ***********************************************************************************************
* @class        VisualizationObjectJointSliding
...
* @date         2026-02-28  22:54:03 (last modified)
*
...
#ifndef VISUALIZATIONOBJECTJOINTSLIDING__H
#define VISUALIZATIONOBJECTJOINTSLIDING__H
...
class VisualizationObjectJointSliding: public VisualizationObject // AUTO: 
{
protected: // AUTO: 
...
public: // AUTO: 
    ...
    VisualizationObjectJointSliding()
    {
        show = true;
        drawSize = -1.f;
