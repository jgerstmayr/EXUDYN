...
//        LTG readout functions:
    ...
    py::class_<PyVector3DList>(m, "Vector3DList")
        ...
        .def("Append", &PyVector3DList::PyAppend, "add single array or list to VectorList; array or list must have appropriate dimension!", py::arg("pyArray"))
        .def("GetPythonObject", &PyVector3DList::GetPythonObject, "convert VectorList list of numpy arrays")
        .def("__repr__", [](const PyVector3DList &item) {
            return EXUstd::ToString(item.GetPythonObject()); }, "return the string representation of the VectorList")
