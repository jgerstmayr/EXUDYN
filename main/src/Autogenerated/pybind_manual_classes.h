...
//        SENSORS:
        .def("AddSensor", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.GetMainObjectFactory().AddMainSensor(mainSystem, itemDict); }, "add a sensor with sensor definition in dictionary format; returns (global) sensor number of newly added sensor", py::arg("itemDict"))
        .def("AddSensor", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.GetMainObjectFactory().AddMainSensorPyClass(mainSystem, pyObject); }, "add a sensor with sensor definition from Python sensor class; returns (global) sensor number of newly added sensor", py::arg("pyObject"))
