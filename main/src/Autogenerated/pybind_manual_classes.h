...
//        LTG readout functions:
    ...
    py::class_<PyGeneralContact>(m, "GeneralContact")
        ...
        .def("GetSystemODE2RhsContactForces", &PyGeneralContact::PyGetSystemODE2RhsContactForces, "Get numpy array of system vector, containing contribution of contact forces to system ODE2 Rhs vector; contributions to single objects may be extracted by checking the according LTG-array of according objects (such as rigid bodies); the contact forces vector is computed in each contact iteration;")
