...
//        LTG readout functions:
    ...
    py::class_<PyMatrix3DList>(m, "Matrix3DList")
        .def(py::init<>())
        .def(py::init<const py::object&>(), py::arg("listOfArrays"))
        .def("Append", &PyMatrix3DList::PyAppend, "add single 2D array or list of lists to Matrix3DList; array or lists must have appropriate dimension!", py::arg("pyArray"))
