...
//        pybinding to enum classes:
  ...
  py::enum_<Contact::TypeIndex>(m, "ContactTypeIndex")
    ...
    py::class_<MainSystem>(m, "MainSystem")
        ...
        .def("GetGeneralContact", &MainSystem::GetGeneralContact, "get read/write access to GeneralContact with index generalContactNumber stored in mbs; Examples shows how to access the GeneralContact object added with last AddGeneralContact() command:", py::arg("generalContactNumber"))
