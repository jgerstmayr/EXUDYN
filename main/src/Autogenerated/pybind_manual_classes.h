...
//        NODES:
        .def("AddNode", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.AddMainNode(itemDict); }, "add a node with nodeDefinition in dictionary format; returns (global) node number of newly added node", py::arg("itemDict"))
        .def("AddNode", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.AddMainNodePyClass(pyObject); }, "add a node with nodeDefinition from Python node class; returns (global) node number of newly added node", py::arg("pyObject"))
...
//        OBJECTS:
        .def("AddObject", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.AddMainObject(itemDict); }, "add a object with objectDefinition in dictionary format; returns (global) object number of newly added object", py::arg("itemDict"))
        .def("AddObject", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.AddMainObjectPyClass(pyObject); }, "add a object with objectDefinition from Python object class; returns (global) object number of newly added object", py::arg("pyObject"))
...
//        MARKER:
        .def("AddMarker", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.AddMainMarker(itemDict); }, "add a marker with markerDefinition in dictionary format; returns (global) marker number of newly added marker", py::arg("itemDict"))
        .def("AddMarker", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.AddMainMarkerPyClass(pyObject); }, "add a marker with markerDefinition from Python marker class; returns (global) marker number of newly added marker", py::arg("pyObject"))
...
//        LOADS:
        .def("AddLoad", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.AddMainLoad(itemDict); }, "add a load with loadDefinition in dictionary format; returns (global) load number of newly added load", py::arg("itemDict"))
        .def("AddLoad", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.AddMainLoadPyClass(pyObject); }, "add a load with loadDefinition from Python load class; returns (global) load number of newly added load", py::arg("pyObject"))
...
//        SENSORS:
        .def("AddSensor", [](MainSystem& mainSystem, py::dict itemDict) {return mainSystem.AddMainSensor(itemDict); }, "add a sensor with sensor definition in dictionary format; returns (global) sensor number of newly added sensor", py::arg("itemDict"))
        .def("AddSensor", [](MainSystem& mainSystem, py::object pyObject) {return mainSystem.AddMainSensorPyClass(pyObject); }, "add a sensor with sensor definition from Python sensor class; returns (global) sensor number of newly added sensor", py::arg("pyObject"))
