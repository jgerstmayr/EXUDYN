...
//        MARKER:
        ...
        .def("GetMarkerOutput", &MainSystem::PyGetMarkerOutputVariable, "get the ouput of the marker specified with the OutputVariableType; currently only provides Position and Velocitiy for position based markers and RotationMatrix as well as AngularVelocity(Local) for markers providing additionally orientation", py::arg("markerNumber"), py::arg("variableType"), py::arg("configuration") = ConfigurationType::Current)
