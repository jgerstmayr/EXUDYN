...
* @date         AUTO: 2020-01-09 (last modfied)
*
...
public: // AUTO: 
  ...
  bool computeInitialAccelerations;               //!< AUTO: true: compute initial accelerations from system EOM in acceleration form; false: use zero accelerations
