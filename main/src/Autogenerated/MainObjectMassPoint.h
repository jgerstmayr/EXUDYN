...
public: // AUTO: 
    ...
    virtual py::dict GetDictionary(bool addGraphicsData=false) const override
    {
        ...
        d["VgraphicsData"] = PyGetBodyGraphicsDataList(visualizationObjectMassPoint->GetGraphicsData(), addGraphicsData); //! AUTO: cast variables into python (not needed for standard types) 
        return d; 
    }
    ...
    virtual void SetParameter(const STDstring& parameterName, const py::object& value) override 
    {
        ...
        else if (parameterName.compare("VgraphicsData") == 0) { PyWriteBodyGraphicsDataList(value, visualizationObjectMassPoint->GetGraphicsData()); } //! AUTO: get parameter
