...
// AUTO:  ++++++++++++++++++++++
 ...
 //add namespace for access to dictionaries  //! AUTO: read access to structure; converting into dictionary
  py::dict GetDictionaryWithTypeInfo(const SolutionSettings& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "add ODE2 velocities to solution file";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "add ODE2 accelerations to solution file";
  ...
  py::dict GetDictionaryWithTypeInfo(const DiscontinuousSettings& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.iterationTolerance;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
  ...
  py::dict GetDictionaryWithTypeInfo(const NewtonSettings& data) {
    ...
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "0 ... use residual for computation of error (standard); 1 ... use ODE2 and ODE1 newton increment for error (set relTol and absTol to same values!) ==> may be advantageous if residual is zero, e.g., in kinematic analysis; TAKE CARE with this flag";
