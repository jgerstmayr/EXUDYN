...
inline py::dict GetDictionaryWithTypeInfo(const GeneralizedAlphaSettings& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: for Lie group nodes, the integrator uses the original kinematic relations of the Bruls and Cardona 2010 paper; False (recommended): higher accuracy as proposed in paper by Holzinger, Arnold, Gerstmayr, sigma-modified Lie group generalized alpha methods for constrained multibody systems, 2025 (to be sumitted)";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.storeInitialAlgebraicCoordinates;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: IF computeInitialAccelerations=True, store initial algebraic coordinates (usually the Lagrange multipliers) in the initial coordinates vector (and thus in the first line of the coordinates solution file); for further details on limitations, see computeInitialAccelerations";
    structureDict["storeInitialAlgebraicCoordinates"] = d;
...
inline py::dict GetDictionary(const GeneralizedAlphaSettings& data) {
    ...
    structureDict["storeInitialAlgebraicCoordinates"] = data.storeInitialAlgebraicCoordinates;
...
inline void SetDictionary(GeneralizedAlphaSettings& data, const py::dict& d) {
    ...
    data.storeInitialAlgebraicCoordinates = py::cast<bool>(d["storeInitialAlgebraicCoordinates"]);
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsGeneral& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetBoundingBoxZoomAllFactor();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
    d["description"] = "factor on boundingBox for zoom all (without minimum offset)";
    structureDict["boundingBoxZoomAllFactor"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetBoundingBoxZoomAllOffset();
    d["type"] = "UFloat";
    d["size"] = std::vector<int>{1};
    d["description"] = "minimum offset to bounding box of scene in window - width or height, whatever is smaller; adjust for very small or large scenes; may be negative";
    structureDict["boundingBoxZoomAllOffset"] = d;
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetCoordinateSystemSize();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetGraphicsUpdateInterval();
    d["type"] = "UFloat";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetMinSceneSize();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetRendererStartupTimeout();
    d["type"] = "PInt";
    d["size"] = std::vector<int>{1};
    d["description"] = "OpenGL render windows startup timeout in ms (change might be necessary if CPU is very slow)";
    structureDict["rendererStartupTimeout"] = d;
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "if true, use exact scene bounding box (but not including texts) for zoom; does not include perspective effects!";
    structureDict["zoomAllUseBoundingBox"] = d;
...
inline py::dict GetDictionary(const VSettingsGeneral& data) {
    ...
    structureDict["boundingBoxZoomAllFactor"] = data.PyGetBoundingBoxZoomAllFactor();
    structureDict["boundingBoxZoomAllOffset"] = data.PyGetBoundingBoxZoomAllOffset();
    structureDict["circleTiling"] = data.PyGetCircleTiling();
    structureDict["coordinateSystemSize"] = data.PyGetCoordinateSystemSize();
    structureDict["cylinderTiling"] = data.PyGetCylinderTiling();
    structureDict["graphicsUpdateInterval"] = data.PyGetGraphicsUpdateInterval();
    ...
    structureDict["minSceneSize"] = data.PyGetMinSceneSize();
    structureDict["pointSize"] = data.PyGetPointSize();
    ...
    structureDict["rendererStartupTimeout"] = data.PyGetRendererStartupTimeout();
...
inline void SetDictionary(VSettingsGeneral& data, const py::dict& d) {
    ...
    data.boundingBoxZoomAllFactor = py::cast<float>(d["boundingBoxZoomAllFactor"]);
    data.boundingBoxZoomAllOffset = py::cast<float>(d["boundingBoxZoomAllOffset"]);
    ...
    data.rendererStartupTimeout = py::cast<Index>(d["rendererStartupTimeout"]);
    ...
    data.zoomAllUseBoundingBox = py::cast<bool>(d["zoomAllUseBoundingBox"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsContourAdvanced& data) {
    ...
    structureDict["contourColorMax"] = d;
    ...
    structureDict["contourColorMin"] = d;
...
//! AUTO: read access to structure; converting into dictionary without type info
inline py::dict GetDictionary(const VSettingsContourAdvanced& data) {
    auto structureDict = py::dict();
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsBeams& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "if implemented for element, cross section is drawn as solid (filled) instead of wire-frame; NOTE: some quantities may not be interpolated correctly over cross section in visualization; equivalent to drawSolid of shells";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetDrawVerticalFactor();
    d["type"] = "UFloat";
    d["size"] = std::vector<int>{1};
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "if True, the interpolation along the beam axis may be lower than the beam element order; this may, however, show more consistent values than a full interpolation, e.g. for strains or forces";
...
inline py::dict GetDictionary(const VSettingsBeams& data) {
    ...
    structureDict["drawVerticalFactor"] = data.PyGetDrawVerticalFactor();
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsShells& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetThicknessFactor();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
    d["description"] = "a factor multiplied with the thickness of shells/plates only for visualization (e.g. to make some effects more visible)";
    structureDict["thicknessFactor"] = d;
...
inline py::dict GetDictionary(const VSettingsShells& data) {
    ...
    structureDict["thicknessFactor"] = data.PyGetThicknessFactor();
    return structureDict;
}

//! AUTO: write access to data structure; converting dictionary d into structure
inline void SetDictionary(VSettingsShells& data, const py::dict& d) {
    data.drawSolid = py::cast<bool>(d["drawSolid"]);
    data.thicknessFactor = py::cast<float>(d["thicknessFactor"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsCamera& data) {
    ...
    structureDict["cameraPosition"] = d;
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "distance of clipping plane on normal vector; see also clippingPlaneNormal and openGL.advanced.clippingPlaneColor";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.modelCentricView;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: rotations and translations are applied to model, while camera stays far enough away from the model and always captures the whole model (everything is in front of camera plane); False: camera moves and rotates while model stays in physical space; only geometry in front of camera is visible; note that the behavior of trackMarker changes with modelCentricView and some features are not available in case of modelCentricView=False.";
    structureDict["modelCentricView"] = d;
    ...
    structureDict["nearFarPlaneOffset"] = d;
    ...
    d["type"] = "UFloat";
    d["size"] = std::vector<int>{1};
    d["description"] = "parameter prescribes amount of perspective (0=no perspective=orthographic projection; positive values increase perspective; feasible values are 0.001 (little perspective) ... 1 (extreme: 5), where larger values are possible but should be used with care; NOTE that the relation to the common field of view (FOV) angle alpha, with alpha=90°, is given by perspective = tan(alpha/2) = 1; mouse coordinates (F3) can not be shown with perspective>0";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.useRaytracer;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: use (software) raytracer for this view; False: use standard OpenGL renderer";
    structureDict["useRaytracer"] = d;
...
inline void SetDictionary(VSettingsCamera& data, const py::dict& d) {
    ...
    data.modelCentricView = py::cast<bool>(d["modelCentricView"]);
    ...
    data.useRaytracer = py::cast<bool>(d["useRaytracer"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsScene& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetDrawCoordinateSystem();
    d["type"] = "UInt";
    d["size"] = std::vector<int>{1};
    d["description"] = "0 = no coordinate system shown, 1 = draw lines with text, 2 = draw arrows, 3 = draw arrows with text";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show edges of triangles; using the options showFaces=false and showFaceEdges=true gives are wire frame representation";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show faces of triangles, etc.; using the options showFaces=false and showFaceEdges=true gives are wireframe representation";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show lines (other lines than face and mesh edges)";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show edges of finite elements; independent of showFaceEdges";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show faces of finite elements; independent of showFaces";
    structureDict["showMeshFaces"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetWorldBasisSize();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
...
//! AUTO: read access to structure; converting into dictionary without type info
inline py::dict GetDictionary(const VSettingsScene& data) {
    auto structureDict = py::dict();
    structureDict["drawCoordinateSystem"] = data.PyGetDrawCoordinateSystem();
    ...
    structureDict["worldBasisSize"] = data.PyGetWorldBasisSize();
    return structureDict;
}

//! AUTO: write access to data structure; converting dictionary d into structure
inline void SetDictionary(VSettingsScene& data, const py::dict& d) {
    data.drawCoordinateSystem = py::cast<Index>(d["drawCoordinateSystem"]);
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsWindow& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: all movements (with mouse/keys), rotations, zoom are disabled; the view is either based on initial values (or on the current state) ==> initial zoom, rotation and center point need to be adjusted, approx. 0.4*maxSceneSize is a good value";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: render window of respective view will be maximized at startup";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show OpenGL coordinates and distance to last left mouse button pressed position in renderer status message; switched on/off with key 'F3'; only works for axis-aligned ortho-projections";
    structureDict["showMouseCoordinates"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.showRenderStateInfo;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show renderer.state infos regarding zoom, offset and rotation in renderer status message; switched on/off with 'CTRL-F3'";
    structureDict["showRenderStateInfo"] = d;
...
inline py::dict GetDictionary(const VSettingsWindow& data) {
    ...
    structureDict["globalFontSize"] = data.PyGetGlobalFontSize();
...
inline void SetDictionary(VSettingsWindow& data, const py::dict& d) {
    ...
    data.globalFontSize = py::cast<float>(d["globalFontSize"]);
    ...
    data.showRenderStateInfo = py::cast<bool>(d["showRenderStateInfo"]);
...
//! AUTO: read access to structure; converting into dictionary without type info
inline py::dict GetDictionary(const VSettingsView& data) {
    auto structureDict = py::dict();
    structureDict["camera"] = GetDictionary(data.camera);
    structureDict["scene"] = GetDictionary(data.scene);
    structureDict["window"] = GetDictionary(data.window);
    return structureDict;
}

//! AUTO: write access to data structure; converting dictionary d into structure
inline void SetDictionary(VSettingsView& data, const py::dict& d) {
    SetDictionary(data.camera, py::cast<py::dict>(d["camera"]));
    SetDictionary(data.scene, py::cast<py::dict>(d["scene"]));
...
//! AUTO: read access to structure; converting into dictionary without type info
inline py::dict GetDictionary(const VSettingsWindowDeprecated& data) {
    auto structureDict = py::dict();
    return structureDict;
}

//! AUTO: write access to data structure; converting dictionary d into structure
inline void SetDictionary(VSettingsWindowDeprecated& data, const py::dict& d) {
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsDialogs& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: During dialogs, the OpenGL render windows will still get updates of changes in dialogs, etc., which may cause problems on some platforms or for some (complicated) models; False: changes of dialogs will take effect when dialogs are closed";
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsRaytracerAdvanced& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetShadowScalingFactor();
    d["type"] = "UInt";
    d["size"] = std::vector<int>{1};
    ...
    structureDict["shadowScalingFactor"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetShadowSmoothingSteps();
    d["type"] = "UInt";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.showText;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: show any kind of status text, node numbers, object numbers, etc. (depending on settings); False: do not show any text in raytracer, independently of settings";
    structureDict["showText"] = d;
...
inline py::dict GetDictionary(const VSettingsRaytracerAdvanced& data) {
    ...
    structureDict["shadowScalingFactor"] = data.PyGetShadowScalingFactor();
    structureDict["shadowSmoothingSteps"] = data.PyGetShadowSmoothingSteps();
    structureDict["showText"] = data.showText;
...
inline void SetDictionary(VSettingsRaytracerAdvanced& data, const py::dict& d) {
    ...
    data.shadowScalingFactor = py::cast<Index>(d["shadowScalingFactor"]);
    data.shadowSmoothingSteps = py::cast<Index>(d["shadowSmoothingSteps"]);
    data.showText = py::cast<bool>(d["showText"]);
    data.tilesPerThread = py::cast<Index>(d["tilesPerThread"]);
    data.zBiasLines = py::cast<float>(d["zBiasLines"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsRaytracer& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetGlobalFogDensity();
    d["type"] = "UFloat";
    d["size"] = std::vector<int>{1};
    ...
    d["type"] = "PInt";
    d["size"] = std::vector<int>{1};
    d["description"] = "Multi-sampling used for rendering of faces, lines and text; increases image quality along edges (lines, etc.) but INCREASES rendering costs dramatically (multiSampling=3 => 3x3=9 times slower); also used for shadow if shadowScalingFactor=0; values only accepted in range [1..4]";
    ...
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "1: print out some debug information on rendering, in particular rendering timings and counter; 2 and higher: advanced debug information";
...
inline py::dict GetDictionary(const VSettingsRaytracer& data) {
    ...
    structureDict["globalFogDensity"] = data.PyGetGlobalFogDensity();
...
inline void SetDictionary(VSettingsRaytracer& data, const py::dict& d) {
    ...
    data.globalFogDensity = py::cast<float>(d["globalFogDensity"]);
    ...
    data.numberOfThreads = py::cast<Index>(d["numberOfThreads"]);
    data.verbose = py::cast<Index>(d["verbose"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsOpenGLAdvanced& data) {
    ...
    structureDict["faceNormalsColor"] = d;
    ...
    d["description"] = "initial model rotation matrix for OpenGl; in python use e.g.: initialModelRotation=[[1,0,0],[0,1,0],[0,0,1]]; only used in case that modelCentricView=True";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: the camera origin is used to compute shininess effects (more realistic); maps to OpenGL glLightModeli(GL_LIGHT_MODEL_LOCAL_VIEWER,...)";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.showBoundingBox;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "show scene bounding box (red), as available in renderState.boundingBox; NOTE that the bounding box is only updated with ZoomAll or at startup; this is a debug flag and it may show reasongs for strange ZoomAll behavior, as ZoomAll should zoom to the bounding box; does only work for perspective=0";
    structureDict["showBoundingBox"] = d;
    ...
    structureDict["vertexNormalsColor"] = d;
...
inline void SetDictionary(VSettingsOpenGLAdvanced& data, const py::dict& d) {
    ...
    data.showBoundingBox = py::cast<bool>(d["showBoundingBox"]);
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsLight& data) {
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "only used by raytracers: radius of light used to compute smooth shadows (approximated by raytracer.lightRadiusVariations); if lightRadiusVariations>1, this value defines the radius of the light, converting point lights into distributed lights (slower)";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.useCameraFrame;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "set False to set light positions and directions relative to model frame; True: lights are in camera frame, not following the visual transformations; this was True up to Exudyn 1.9.174";
    structureDict["useCameraFrame"] = d;

    return structureDict;
}

//! AUTO: read access to structure; converting into dictionary without type info
inline py::dict GetDictionary(const VSettingsLight& data) {
    auto structureDict = py::dict();
    structureDict["constantAttenuation"] = data.constantAttenuation;
    structureDict["diffuse"] = data.diffuse;
    ...
    structureDict["useCameraFrame"] = data.useCameraFrame;
    return structureDict;
}

//! AUTO: write access to data structure; converting dictionary d into structure
inline void SetDictionary(VSettingsLight& data, const py::dict& d) {
    data.constantAttenuation = py::cast<float>(d["constantAttenuation"]);
    data.diffuse = py::cast<float>(d["diffuse"]);
    data.enable = py::cast<bool>(d["enable"]);
    data.lightRadius = py::cast<float>(d["lightRadius"]);
    data.linearAttenuation = py::cast<float>(d["linearAttenuation"]);
    data.position = py::cast<std::array<float,4>>(d["position"]);
    data.quadraticAttenuation = py::cast<float>(d["quadraticAttenuation"]);
    data.shadow = py::cast<float>(d["shadow"]);
    data.specular = py::cast<float>(d["specular"]);
    data.useCameraFrame = py::cast<bool>(d["useCameraFrame"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsOpenGL& data) {
    ...
    structureDict["light2"] = GetDictionaryWithTypeInfo(data.light2);
    structureDict["light3"] = GetDictionaryWithTypeInfo(data.light3);
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.PyGetZMaxSceneFactor();
    d["type"] = "PFloat";
    d["size"] = std::vector<int>{1};
    d["description"] = "factor multiplied with maxSceneSize to avoid clipping of modelview; larger values reduce clipping of near or far objects, but may lead to artifacts (so-called Z-fighting)";
    structureDict["zMaxSceneFactor"] = d;
...
inline py::dict GetDictionary(const VSettingsOpenGL& data) {
    auto structureDict = py::dict();
    structureDict["advanced"] = GetDictionary(data.advanced);
    structureDict["light0"] = GetDictionary(data.light0);
    structureDict["light1"] = GetDictionary(data.light1);
    structureDict["light2"] = GetDictionary(data.light2);
    structureDict["light3"] = GetDictionary(data.light3);
    ...
    structureDict["multiSampling"] = data.PyGetMultiSampling();
    structureDict["zMaxSceneFactor"] = data.PyGetZMaxSceneFactor();
    return structureDict;
}
...
inline void SetDictionary(VSettingsOpenGL& data, const py::dict& d) {
    SetDictionary(data.advanced, py::cast<py::dict>(d["advanced"]));
    SetDictionary(data.light0, py::cast<py::dict>(d["light0"]));
    SetDictionary(data.light1, py::cast<py::dict>(d["light1"]));
    SetDictionary(data.light2, py::cast<py::dict>(d["light2"]));
    SetDictionary(data.light3, py::cast<py::dict>(d["light3"]));
    ...
    data.multiSampling = py::cast<Index>(d["multiSampling"]);
    data.zMaxSceneFactor = py::cast<float>(d["zMaxSceneFactor"]);
}
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsInteractiveAdvanced& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: enable mouse click to highlights item (default: red)";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: enable left mouse click on items to show basic information";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: enable right mouse click on items to show dictionary (read only!)";
...
inline py::dict GetDictionaryWithTypeInfo(const VSettingsInteractive& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.autoRotateModelView;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: rotate model view with autorotation";
    structureDict["autoRotateModelView"] = d;
    ...
    structureDict["autoRotationVelocity"] = d;
    ...
    d["type"] = "Int";
    d["size"] = std::vector<int>{1};
    d["description"] = "index of item that shall be highlighted (e.g., to find item which cauess problems); if set -1, no item is highlighted";
    ...
    d["type"] = "ItemType";
    d["size"] = std::vector<int>{1};
    d["description"] = "item type (Node, Object, ...) that shall be highlighted (e.g., to find item which cauess problems)";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: ignore keyboard input except escape and 'F2' keys; used for interactive mode, e.g., to perform kinematic analysis; This flag can be switched with key 'F2'; if ignoreKeys=True, then keyPressUserFunction can be used!";
    structureDict["ignoreKeys"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.logMouseCoordinates;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "True: if showMouseCoordinates=True, also log mouse coordinates (transformed to model coordinates); only works for axis-aligned ortho-projections and shows the coordinates of the current plane";
    structureDict["logMouseCoordinates"] = d;
...
inline py::dict GetDictionary(const VSettingsInteractive& data) {
    ...
    structureDict["logMouseCoordinates"] = data.logMouseCoordinates;
...
inline void SetDictionary(VSettingsInteractive& data, const py::dict& d) {
    ...
    data.autoRotateModelView = py::cast<bool>(d["autoRotateModelView"]);
    ...
    data.logMouseCoordinates = py::cast<bool>(d["logMouseCoordinates"]);
...
inline py::dict GetDictionaryWithTypeInfo(const VisualizationSettings& data) {
    ...
    structureDict["view0"] = GetDictionaryWithTypeInfo(data.view0);
    structureDict["view1"] = GetDictionaryWithTypeInfo(data.view1);
    structureDict["view2"] = GetDictionaryWithTypeInfo(data.view2);
    structureDict["view3"] = GetDictionaryWithTypeInfo(data.view3);
...
inline py::dict GetDictionary(const VisualizationSettings& data) {
    ...
    structureDict["view0"] = GetDictionary(data.view0);
    structureDict["view1"] = GetDictionary(data.view1);
    structureDict["view2"] = GetDictionary(data.view2);
    structureDict["view3"] = GetDictionary(data.view3);
...
inline void SetDictionary(VisualizationSettings& data, const py::dict& d) {
    ...
    SetDictionary(data.view0, py::cast<py::dict>(d["view0"]));
    SetDictionary(data.view1, py::cast<py::dict>(d["view1"]));
    SetDictionary(data.view2, py::cast<py::dict>(d["view2"]));
    SetDictionary(data.view3, py::cast<py::dict>(d["view3"]));
