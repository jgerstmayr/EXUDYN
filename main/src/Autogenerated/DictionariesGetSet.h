...
// AUTO:  ++++++++++++++++++++++
 ...
 //add namespace for access to dictionaries  //! AUTO: read access to structure; converting into dictionary
  py::dict GetDictionaryWithTypeInfo(const SolutionSettings& data) {
    ...
    d["description"] = "flag (true/false), which determines if (global) solution vector is written to file";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "flag (true/false); if true, solution is appended to existing file (otherwise created)";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "solution is written as displacements, velocities[, accelerations] [,algebraicCoordinates] [,DataCoordinates]";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "solution is written as displacements, [velocities,] [accelerations,], algebraicCoordinates (=Lagrange multipliers) [,DataCoordinates]";
    ...
    d["type"] = "FileName";
    d["size"] = std::vector<int>{1};
    d["description"] = "filename and (relative) path of solution file containing all coordinates versus time";
    ...
    d["type"] = "FileName";
    d["size"] = std::vector<int>{1};
    d["description"] = "filename and (relative) path of text file showing detailed information during solving; detail level according to yourSolver.verboseModeFile";
    ...
    d["type"] = "String";
    d["size"] = std::vector<int>{1};
    d["description"] = "special information added to header of solution file (e.g. parameters and settings, modes, ...)";
  ...
  py::dict GetDictionaryWithTypeInfo(const NumericalDifferentiationSettings& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.minimumCoordinateSize;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "true: system wide differentiation (e.g. all ODE2 equations w.r.t. all ODE2 coordinates); false: only local (object) differentiation";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "true: for the size estimation of the differentiation parameter, the reference coordinate q^{Ref}_i is added to ODE2 coordinates --> see; false: only the current coordinate is used for size estimation of the differentiation parameter";
  ...
  py::dict GetDictionaryWithTypeInfo(const NewtonSettings& data) {
    ...
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "0 ... use residual for computation of error (standard); 1 ... use change of solution increment for error (set relTol and absTol to same values!) ==> may be advantageous if residual is zero, e.g., in kinematic analysis; TAKE CARE with this flag";
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.modifiedNewtonContractivity;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.maxModifiedNewtonIterations;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.maxModifiedNewtonRestartIterations;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.maximumSolutionNorm;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.maxDiscontinuousIterations;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "maximum number of discontinuous (post Newton) iterations";
    structureDict["maxDiscontinuousIterations"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.ignoreMaxDiscontinuousIterations;
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "continue solver if maximum number of discontinuous (post Newton) iterations is reached (ignore tolerance)";
    structureDict["ignoreMaxDiscontinuousIterations"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.discontinuousIterationTolerance;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    ...
    structureDict["discontinuousIterationTolerance"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.stepInformation;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
  ...
  void SetDictionary(NewtonSettings& data, const py::dict& d) {
    ...
    data.maxDiscontinuousIterations = py::cast<Index>(d["maxDiscontinuousIterations"]);
    data.ignoreMaxDiscontinuousIterations = py::cast<bool>(d["ignoreMaxDiscontinuousIterations"]);
    data.discontinuousIterationTolerance = py::cast<Real>(d["discontinuousIterationTolerance"]);
  ...
  py::dict GetDictionaryWithTypeInfo(const GeneralizedAlphaSettings& data) {
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "true: compute initial accelerations from system EOM in acceleration form; false: use zero accelerations";
  ...
  py::dict GetDictionaryWithTypeInfo(const TimeIntegrationSettings& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.startTime;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    d["description"] = "start time of time integration (usually set to zero)";
    structureDict["startTime"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.endTime;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    d["description"] = "end time of time integration";
    structureDict["endTime"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.numberOfSteps;
    d["type"] = "UInt";
    d["size"] = std::vector<int>{1};
    d["description"] = "number of steps in time integration; stepsize is computed from (endTime-startTime)/numberOfSteps";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "true: use step reduction if step fails; false: constant step size";
    structureDict["adaptiveStep"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.minimumStepSize;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    d["description"] = "lower limit of time step size, before integrator stops";
    structureDict["minimumStepSize"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.verboseMode;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    ...
    d["type"] = "String";
    d["size"] = std::vector<int>{1};
    d["description"] = "Python code to be executed prior to every step and after last step, e.g. for postprocessing";
  ...
  py::dict GetDictionaryWithTypeInfo(const StaticSolverSettings& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.numberOfLoadSteps;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.loadStepGeometricRange;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.stabilizerODE2term;
    d["type"] = "UReal";
    d["size"] = std::vector<int>{1};
    d["description"] = "add mass-proportional stabilizer term in ODE2 part of jacobian for stabilization (scaled ), e.g. of badly conditioned problems; the diagnoal terms are scaled with stabilizer = (1-loadStepFactor^2), and go to zero at the end of all load steps: loadStepFactor=1 -> stabilizer = 0";
    ...
    d["type"] = "String";
    d["size"] = std::vector<int>{1};
    d["description"] = "Python code to be executed prior to every load step and after last step, e.g. for postprocessing";
    structureDict["preStepPyExecute"] = d;
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsGeneral& data) {
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "general text size if not overwritten";
    ...
    d["description"] = "red, green, blue and alpha values for background of render window (white=[1,1,1,1]; black = [0,0,0,1])";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "size of coordinate system relative to screen";
    ...
    d["type"] = "bool";
    d["size"] = std::vector<int>{1};
    d["description"] = "false = no info about computation (current time, solver, etc.) shown";
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsOpenGL& data) {
    ...
    d["type"] = "Vector";
    d["size"] = std::vector<int>{4};
    d["description"] = "4f position vector of GL light0; 4th value should be 0, otherwise the vector obtains a special interpretation, see opengl manuals";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "ambient value of GL light0";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "diffuse value of GL light0";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "specular value of GL light0";
    ...
    d["type"] = "Vector";
    d["size"] = std::vector<int>{4};
    d["description"] = "4f position vector of GL light1; 4th value should be 0, otherwise the vector obtains a special interpretation, see opengl manuals";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "ambient value of GL light1";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "diffuse value of GL light1";
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "specular value of GL light1";
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsContour& data) {
    ...
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "select the component of the chosen output variable; e.g., for displacements, 3 components are available: 0 == x, 1 == y, 2 == z component; if this component is not available by certain objects or nodes, no value is drawn";
    ...
    d["size"] = std::vector<int>{1};
    d["description"] = "selected contour plot output variable type; select OutputVariableType.None to deactivate contour plotting.";
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsExportImages& data) {
    ...
    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.saveImageTimeOut;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
    d["description"] = "timeout for safing a frame as image to disk; this is the amount of time waited for redrawing; increase for very complex scenes";
    ...
    d["type"] = "FileName";
    d["size"] = std::vector<int>{1};
    d["description"] = "filename (without extension!) and (relative) path for image file(s) with consecutive numbering (e.g., frame0000.tga, frame0001.tga,...); folders must already exist!";
    structureDict["saveImageFileName"] = d;

    d = py::dict(); //reset local dict
    d["itemIdentifier"] = std::string(""); //identifier for item
    d["value"] = data.saveImageFileCounter;
    d["type"] = "Index";
    d["size"] = std::vector<int>{1};
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsLoads& data) {
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "global load size; if -1.f, node size is relative to maxSceneSize";
    structureDict["defaultSize"] = d;
  ...
  py::dict GetDictionaryWithTypeInfo(const VSettingsSensors& data) {
    ...
    d["type"] = "float";
    d["size"] = std::vector<int>{1};
    d["description"] = "global sensor size; if -1.f, node size is relative to maxSceneSize";
    structureDict["defaultSize"] = d;
