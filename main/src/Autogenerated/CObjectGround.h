...
* @date         2019-12-10  23:25:22 (last modfied)
*
...
{
public: // AUTO: 
    Vector3D referencePosition;                   //!< AUTO: reference position for ground object; local position is added on top of reference position for a ground object
