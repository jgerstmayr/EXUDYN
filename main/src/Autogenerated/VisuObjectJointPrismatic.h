/** ***********************************************************************************************
* @class        VisualizationObjectJointPrismatic
* @brief        A prismatic joint in 3D; constrains the relative rotation of two rigid body markers and relative motion w.r.t. two axes. An additional local rotation (rotationMarker) can be used to transform the markers' coordinate systems into the joint coordinate system. For easier definition of the joint, use the exudyn.rigidbodyUtilities function AddPrismaticJoint(...) for two rigid bodies (or ground).
*
...
#ifndef VISUALIZATIONOBJECTJOINTPRISMATIC__H
#define VISUALIZATIONOBJECTJOINTPRISMATIC__H
...
class VisualizationObjectJointPrismatic: public VisualizationObject // AUTO: 
{
protected: // AUTO: 
...
public: // AUTO: 
    ...
    VisualizationObjectJointPrismatic()
    {
        show = true;
        axesRadius = 0.1f;
        axesLength = 0.4f;
