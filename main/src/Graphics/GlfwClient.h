...
#if !defined(__EXUDYN__APPLE__) && !defined(__EXUDYN__LINUX__ARM__)
//#define __EXUDYN_USE_OPENVR //enable interfaces for openVR; requires openVR library; may lead to compilation problems
#endif
#endif // !EXUDYN_RELEASE
...
private: //to be called internally only!
	...
	static void Render3Dobjects(GLFWwindow* window, const Matrix3DF& projectionA, const Float3& projectionPos, int width, int height, float ratio);
