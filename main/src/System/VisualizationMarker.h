...
* @brief		
* @details		Details:
* 				- a base class for visualization of a marker
...
*
************************************************************************************************ */
#ifndef VISUALIZATIONMARKER__H
#define VISUALIZATIONMARKER__H
...
public:
	virtual ~VisualizationMarker() {} //added for correct deletion of derived classes
