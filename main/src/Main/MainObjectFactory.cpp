...
MainNode* MainObjectFactory::CreateMainNode(MainSystem& mainSystem, STDstring nodeType)
{
	...
	else if (nodeType == "1D")
	{
		...
		VisualizationNode1D* vNode = new VisualizationNode1D();				//visualization item
...
MainObject* MainObjectFactory::CreateMainObject(MainSystem& mainSystem, STDstring objectType)
{
	...
	else if (objectType == "Mass1D")
	{
		...
		VisualizationObjectMass1D* vObject = new VisualizationObjectMass1D();				//visualization item
	...
	else if (objectType == "RotationalMass1D")
	{
		...
		VisualizationObjectRotationalMass1D* vObject = new VisualizationObjectRotationalMass1D();				//visualization item
	...
	else if (objectType == "FFRF")
	{
		...
		VisualizationObjectFFRF* vObject = new VisualizationObjectFFRF();				//visualization item
	...
	else if (objectType == "FFRFreducedOrder")
	{
		...
		VisualizationObjectFFRFreducedOrder* vObject = new VisualizationObjectFFRFreducedOrder();				//visualization item
	...
	VisualizationObjectConnectorCoordinateVector* vObject = new VisualizationObjectConnectorCoordinateVector();				//visualization item
...
MainMarker* MainObjectFactory::CreateMainMarker(MainSystem& mainSystem, STDstring markerType)
{
	...
	{
		CMarkerSuperElementPosition* cMarker = new CMarkerSuperElementPosition();							//new point marker
		...
		VisualizationMarkerSuperElementPosition* vMarker = new VisualizationMarkerSuperElementPosition();				//visualization item
	...
	{
		CMarkerNodeRotationCoordinate* cMarker = new CMarkerNodeRotationCoordinate();							//new point marker
		...
		VisualizationMarkerNodeRotationCoordinate* vMarker = new VisualizationMarkerNodeRotationCoordinate();				//visualization item
		((MainMarkerNodeRotationCoordinate*)marker)->SetVisualizationMarker(vMarker);
	}
	else if (markerType == "ObjectODE2Coordinates")
	{
		CMarkerObjectODE2Coordinates* cMarker = new CMarkerObjectODE2Coordinates();							//new point marker
		...
		VisualizationMarkerObjectODE2Coordinates* vMarker = new VisualizationMarkerObjectODE2Coordinates();				//visualization item
...
MainSensor* MainObjectFactory::CreateMainSensor(MainSystem& mainSystem, STDstring sensorType)
{
	...
	else if (sensorType == "SuperElement")
	{
		...
		VisualizationSensorSuperElement* vSensor = new VisualizationSensorSuperElement();				//visualization item
