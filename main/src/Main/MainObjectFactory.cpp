...
#include "Autogenerated/MainNodePoint3DSlope1.h"
#include "Autogenerated/MainNodePoint3DSlope23.h"
...
MainNode* MainObjectFactory::CreateMainNode(MainSystem& mainSystem, STDstring nodeType)
{
	...
	else if (nodeType == "RigidBodyRotVecDataLG")
	{
		...
		((MainNodeRigidBodyRotVecDataLG*)node)->SetVisualizationNode(vNode);
	}
	...
	else if (nodeType == "Point3DSlope1")
	{
		CNodePoint3DSlope1* cNode = new CNodePoint3DSlope1();										//computational item
		cNode->GetCData() = &(mainSystem.GetCSystem()->GetSystemData().GetCData()); //add CData reference to CNode
		node = new MainNodePoint3DSlope1(); //new main node
		((MainNodePoint3DSlope1*)node)->SetCNodePoint3DSlope1(cNode);
		VisualizationNodePoint3DSlope1* vNode = new VisualizationNodePoint3DSlope1();
		((MainNodePoint3DSlope1*)node)->SetVisualizationNode(vNode);
	}
	else if (nodeType == "Point3DSlope23")
	{
		CNodePoint3DSlope23* cNode = new CNodePoint3DSlope23();										//computational item
		cNode->GetCData() = &(mainSystem.GetCSystem()->GetSystemData().GetCData()); //add CData reference to CNode
		node = new MainNodePoint3DSlope23(); //new main node
		((MainNodePoint3DSlope23*)node)->SetCNodePoint3DSlope23(cNode);
		VisualizationNodePoint3DSlope23* vNode = new VisualizationNodePoint3DSlope23();
		((MainNodePoint3DSlope23*)node)->SetVisualizationNode(vNode);
	}
	...
	else if (nodeType == "GenericAE")
	{
		...
		((MainNodeGenericAE*)node)->SetVisualizationNode(vNode);
	}
...
MainObject* MainObjectFactory::CreateMainObject(MainSystem& mainSystem, STDstring objectType)
{
	...
	else if (objectType == "KinematicTree")
	{
		...
		((MainObjectKinematicTree*)object)->SetVisualizationObject(vObject);
	}
	...
	else if (objectType == "ANCFBeam3D")
	{

		CObjectANCFBeam3D* cObject = new CObjectANCFBeam3D();
		cObject->SetCSystemData(&(mainSystem.GetCSystem()->GetSystemData()));		//add CSystemData* to objects (workaround, will be removed)
		object = new MainObjectANCFBeam3D(); //new main object
		((MainObjectANCFBeam3D*)object)->SetCObjectANCFBeam3D(cObject);
		VisualizationObjectANCFBeam3D* vObject = new VisualizationObjectANCFBeam3D();
		((MainObjectANCFBeam3D*)object)->SetVisualizationObject(vObject);
	}
	...
	else if (objectType == "BeamGeometricallyExact3D")
	{
		CObjectBeamGeometricallyExact3D* cObject = new CObjectBeamGeometricallyExact3D();
		cObject->SetCSystemData(&(mainSystem.GetCSystem()->GetSystemData()));		//add CSystemData* to objects (workaround, will be removed)
		object = new MainObjectBeamGeometricallyExact3D(); //new main object
		((MainObjectBeamGeometricallyExact3D*)object)->SetCObjectBeamGeometricallyExact3D(cObject);
		VisualizationObjectBeamGeometricallyExact3D* vObject = new VisualizationObjectBeamGeometricallyExact3D();
		((MainObjectBeamGeometricallyExact3D*)object)->SetVisualizationObject(vObject);
	}
	...
	else if (objectType == "ConnectorHydraulicActuatorSimple")
	{
		...
		((MainObjectConnectorHydraulicActuatorSimple*)object)->SetVisualizationObject(vObject);
	}
	...
	((MainObjectConnectorLinearSpringDamper*)object)->SetVisualizationObject(vObject);
	}
...
MainMarker* MainObjectFactory::CreateMainMarker(MainSystem& mainSystem, STDstring markerType)
{
	...
	else if (markerType == "KinematicTreeRigid")
	{
		CMarkerKinematicTreeRigid* cMarker = new CMarkerKinematicTreeRigid();							
		marker = new MainMarkerKinematicTreeRigid(); //new main marker
		((MainMarkerKinematicTreeRigid*)marker)->SetCMarkerKinematicTreeRigid(cMarker);
		VisualizationMarkerKinematicTreeRigid* vMarker = new VisualizationMarkerKinematicTreeRigid();				
		((MainMarkerKinematicTreeRigid*)marker)->SetVisualizationMarker(vMarker);
	}	
...
MainSensor* MainObjectFactory::CreateMainSensor(MainSystem& mainSystem, STDstring sensorType)
{
	...
	else if (sensorType == "KinematicTree")
	{
		CSensorKinematicTree* cSensor = new CSensorKinematicTree();							//new point sensor
		sensor = new MainSensorKinematicTree(); //new main sensor
		((MainSensorKinematicTree*)sensor)->SetCSensorKinematicTree(cSensor);
		VisualizationSensorKinematicTree* vSensor = new VisualizationSensorKinematicTree();
		((MainSensorKinematicTree*)sensor)->SetVisualizationSensorKinematicTree(vSensor);
	}
