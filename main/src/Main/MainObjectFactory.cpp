...
MainObject* MainObjectFactory::CreateMainObject(MainSystem& mainSystem, STDstring objectType)
{
	...
	else if (objectType == "ANCFBeam")
	{
		...
		((MainObjectANCFBeam*)object)->SetVisualizationObject(vObject);
	}
	...
	else if (objectType == "BeamGeometricallyExact")
	{
		...
		((MainObjectBeamGeometricallyExact*)object)->SetVisualizationObject(vObject);
	}
	...
	((MainObjectConnectorReevingSystemSprings*)object)->SetVisualizationObject(vObject);
	}
	...
	else if (objectType == "ConnectorCoordinateSpringDamperExt")
	{
		...
		((MainObjectConnectorCoordinateSpringDamperExt*)object)->SetVisualizationObject(vObject);
	}
