...
MainNode* MainObjectFactory::CreateMainNode(MainSystem& mainSystem, STDstring nodeType)
{
	...
	else if (nodeType == "PointSlope1")
	{
		...
		((MainNodePointSlope1*)node)->SetVisualizationNode(vNode);
	}
	else if (nodeType == "PointSlope12")
	{
		...
		((MainNodePointSlope12*)node)->SetVisualizationNode(vNode);
	}
	else if (nodeType == "PointSlope23")
	{
		...
		((MainNodePointSlope23*)node)->SetVisualizationNode(vNode);
		}
...
MainObject* MainObjectFactory::CreateMainObject(MainSystem& mainSystem, STDstring objectType)
{
	...
	else if (objectType == "ANCFCable")
	{
		...
		((MainObjectANCFCable*)object)->SetVisualizationObject(vObject);
		}
