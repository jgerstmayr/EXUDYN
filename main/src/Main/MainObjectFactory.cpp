...
Index MainObjectFactory::AddMainNodePyClass(MainSystem& mainSystem, py::object pyObject)
{
	py::dict dictObject = py::dict(pyObject); //applies dict command to pyObject ==> converts object class to dictionary
	return AddMainNode(mainSystem, dictObject);
}
...
Index MainObjectFactory::AddMainObjectPyClass(MainSystem& mainSystem, py::object pyObject)
{
	py::dict dictObject = py::dict(pyObject); //applies dict command to pyObject ==> converts object class to dictionary
	return AddMainObject(mainSystem, dictObject);
}
...
Index MainObjectFactory::AddMainMarkerPyClass(MainSystem& mainSystem, py::object pyObject)
{
	py::dict dictObject = py::dict(pyObject); //applies dict command to pyObject ==> converts object class to dictionary
	return AddMainMarker(mainSystem, dictObject);
}
...
Index MainObjectFactory::AddMainLoadPyClass(MainSystem& mainSystem, py::object pyObject)
{
	py::dict dictObject = py::dict(pyObject); //applies dict command to pyObject ==> converts object class to dictionary
	return AddMainLoad(mainSystem, dictObject);
}
...
Index MainObjectFactory::AddMainSensorPyClass(MainSystem& mainSystem, py::object pyObject)
{
	py::dict dictObject = py::dict(pyObject); //applies dict command to pyObject ==> converts object class to dictionary
	return AddMainSensor(mainSystem, dictObject);
}
