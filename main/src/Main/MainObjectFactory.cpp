...
MainObject* MainObjectFactory::CreateMainObject(MainSystem& mainSystem, STDstring objectType)
{
	...
	VisualizationObjectConnectorRollingDiscPenalty* vObject = new VisualizationObjectConnectorRollingDiscPenalty();				//visualization item
	...
	VisualizationObjectJointRollingDisc* vObject = new VisualizationObjectJointRollingDisc();				//visualization item
...
MainMarker* MainObjectFactory::CreateMainMarker(MainSystem& mainSystem, STDstring markerType)
{
	...
	{
		CMarkerSuperElementRigid* cMarker = new CMarkerSuperElementRigid();							//new point marker
		...
		VisualizationMarkerSuperElementRigid* vMarker = new VisualizationMarkerSuperElementRigid();				//visualization item
