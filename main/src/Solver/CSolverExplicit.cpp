...
void CSolverExplicitTimeInt::PrecomputeLieGroupStructures(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
	...
	{
		if (EXUstd::IsOfType(cNodes[i]->GetType(), Node::RotationLieGroup))
		{
...
void CSolverExplicitTimeInt::LieGroupODE2StepEvaluation(CSystem& computationalSystem, Vector& solutionODE2,
