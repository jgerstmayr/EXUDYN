...
public:
	...
	virtual bool IsStaticSolver() const { release_assert(0 && "CSolverBase::illegal call"); return false; }
	...
	virtual Real ComputeLoadFactor(const SimulationSettings& simulationSettings) const { release_assert(0 && "CSolverBase::illegal call"); return 0; }

	//! get solver name - needed for output file header and visualization window
	//! +++++ TO BE IMPLEMENTED IN DERIVED CLASS +++++
	virtual const STDstring GetSolverName() const { release_assert(0 && "CSolverBase::illegal call"); return ""; }

	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	//initialize routines
	
	//! initialize solverSpecific,data,it,conv; set/compute initial conditions (solver-specific!); initialize output files
	virtual bool InitializeSolver(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }
	...
	virtual void InitializeSolverOutput(const SimulationSettings& simulationSettings); //{ release_assert(0 && "CSolverBase::illegal call"); }

	//! initialize dense/sparse computation modes
	virtual bool InitializeSolverPreChecks(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }

	//! initialize all data,it,conv; called from InitializeSolver()
	virtual void InitializeSolverData(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }

	//! set/compute initial conditions (solver-specific!); called from InitializeSolver()
	virtual void InitializeSolverInitialConditions(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }
	...
	virtual void FinalizeSolver(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }
	...
	virtual bool SolveSteps(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); return 0; }

	//! update currentTime (and load factor); MUST be overwritten in special solver class
	virtual void UpdateCurrentTime(CSystem& computationalSystem, const SimulationSettings& simulationSettings) { release_assert(0 && "CSolverBase::illegal call"); }

	//! initialize static step / time step; python-functions; do some outputs, checks, etc.
	virtual void InitializeStep(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }

	//! finish static step / time step; write output of results to file
	virtual void FinishStep(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); }

	//! perform discontinuousIteration for static step / time step; CALLS ComputeNewtonResidual 
	virtual bool DiscontinuousIteration(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); return 0; }

	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	//NEWTON:
	//! perform Newton method for given solver method
	virtual bool Newton(CSystem& computationalSystem, const SimulationSettings& simulationSettings);// { release_assert(0 && "CSolverBase::illegal call"); return 0; }

	//! compute residual for Newton method (e.g. static or time step); store result in systemResidual
	//! +++++ TO BE IMPLEMENTED IN DERIVED CLASS +++++
	virtual void ComputeNewtonResidual(CSystem& computationalSystem, const SimulationSettings& simulationSettings) { release_assert(0 && "CSolverBase::illegal call"); }

	//! compute update for currentState from newtonSolution (decrement from residual and jacobian)
	//! +++++ TO BE IMPLEMENTED IN DERIVED CLASS +++++
	virtual void ComputeNewtonUpdate(CSystem& computationalSystem, const SimulationSettings& simulationSettings) { release_assert(0 && "CSolverBase::illegal call"); }

	//! compute jacobian for newton method of given solver method; store result in systemJacobian
	//! +++++ TO BE IMPLEMENTED IN DERIVED CLASS +++++
	virtual void ComputeNewtonJacobian(CSystem& computationalSystem, const SimulationSettings& simulationSettings) { release_assert(0 && "CSolverBase::illegal call"); }
