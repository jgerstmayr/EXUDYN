/** ***********************************************************************************************
* @brief		Implentation for CSolverImplicitSecondOrderTimeIntNew
*
...
bool CSolverImplicitSecondOrderTimeIntNew::ReduceStepSize(CSystem& computationalSystem, const SimulationSettings& simulationSettings, 
...
void CSolverImplicitSecondOrderTimeIntNew::InitializeSolverInitialConditions(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
...
void CSolverImplicitSecondOrderTimeIntNew::UpdateCurrentTime(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
	if (!it.adaptiveStep)
	{
...
void CSolverImplicitSecondOrderTimeIntNew::PreInitializeSolverSpecific(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
...
void CSolverImplicitSecondOrderTimeIntNew::PostInitializeSolverSpecific(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
	//now implemented
...
Real CSolverImplicitSecondOrderTimeIntNew::ComputeNewtonResidual(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
...
void CSolverImplicitSecondOrderTimeIntNew::ComputeNewtonUpdate(CSystem& computationalSystem, const SimulationSettings& simulationSettings, bool initial)
{
...
void CSolverImplicitSecondOrderTimeIntNew::ComputeNewtonJacobian(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
...
//! compute jacobian for newton method of given solver method
bool CSolverImplicitSecondOrderTimeIntNew::Newton(CSystem& computationalSystem, const SimulationSettings& simulationSettings)
{
	bool success = CSolverImplicitSecondOrderTimeIntUserFunction::Newton(computationalSystem, simulationSettings); //includes call to user function
