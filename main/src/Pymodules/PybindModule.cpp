...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	py::class_<MainSystemContainer>(m, "SystemContainer", "SystemContainer: Contains a set of (multibody) systems")
		...
		////CHECKandTHROWstring("SystemContainer.TimeIntegrationSolve(...): this method is deprecated; use exudyn.SolveDynamic(...) instead!");
		////return false;
		...
		//	{
		//		SolverRK1 solver;
		//		returnValue = solver.SolveSystem(*(ms.GetCSystem()), simulationSettings);
		//	}
		//	else if (solverName == "GeneralizedAlphaOldSolver")
		//	{
		//		SolverGeneralizedAlpha solver;
		//		returnValue = solver.SolveSystem(*(ms.GetCSystem()), simulationSettings);
		//	}
		...
		//	//CHECKandTHROWstring("SystemContainer.StaticSolve(...): this method is deprecated; use exudyn.SolveStatic(...) instead!");
		//	//return false;
		//	pout.precision(simulationSettings.outputPrecision);
		//	bool returnValue = false;
		//	try
