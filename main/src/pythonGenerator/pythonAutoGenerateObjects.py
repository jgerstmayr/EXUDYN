...
from autoGenerateHelper import GenerateLatexStrKeywordExamples, ExtractExamplesWithKeyword, RemoveSpacesTabs, CountLines, \
    ...
    PyLatexRST, LatexString2RST, RSTheaderString, FileNameLower #RemoveIndentation, LatexString2RST
...
def WriteFile(parseInfo, parameterList, typeConversion):
    ...
    global fileWriteCnt
    print('\rProcess file '+str(fileWriteCnt).zfill(3), end='', flush=True)
    fileWriteCnt+=1
