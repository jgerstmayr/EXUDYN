...
void CObjectConnectorRigidBodySpringDamper::ComputeODE2RHS(Vector& ode2Rhs, const MarkerDataStructure& markerData) const
{
	CHECKandTHROW(markerData.GetMarkerData(1).velocityAvailable && markerData.GetMarkerData(0).velocityAvailable,
		"CObjectConnectorRigidBodySpringDamper::ComputeODE2RHS: marker do not provide velocityLevel information");
