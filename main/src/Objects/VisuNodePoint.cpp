...
void VisualizationObjectSuperElement::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	...
	bool hasReferenceFrame = cObject->HasReferenceFrame(rigidBodyNodeNumber);
	...
	{
		refRot = ((const CNodeRigidBody*)cObject->GetCNode(rigidBodyNodeNumber))->GetRotationMatrix(ConfigurationType::Visualization);
		refPos = ((const CNodeRigidBody*)cObject->GetCNode(rigidBodyNodeNumber))->GetPosition(ConfigurationType::Visualization);
	}
