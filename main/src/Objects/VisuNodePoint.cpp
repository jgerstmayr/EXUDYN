...
void VisualizationSensorNode::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	...
	if (cNode->GetNodeGroup() == CNodeGroup::ODE2variables)
	{
		...
		if (visualizationSettings.sensors.defaultSize == -1.f) { radius = 0.5f*visualizationSettings.openGL.initialMaxSceneSize * 0.002f; }
		...
		if (visualizationSettings.sensors.showNumbers) { DrawItemNumber(pos, vSystem, itemNumber, "S", currentColor); }
	}
}
