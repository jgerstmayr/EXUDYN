...
void VisualizationObjectGenericODE2::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	...
	{
		refRot = ((const CNodeRigidBody*)cObject->GetCNode(CObjectGenericODE2::ffrfNodeNumber))->GetRotationMatrix(ConfigurationType::Visualization);
		refPos = ((const CNodeRigidBody*)cObject->GetCNode(CObjectGenericODE2::ffrfNodeNumber))->GetPosition(ConfigurationType::Visualization);
	}
...
void VisualizationMarkerGenericBodyPosition::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	...
	if (showMarkerNodes)
	{
		...
		if (cMarker->GetParameters().useFirstNodeAsReferenceFrame)
		{
			...
			A  = ((const CNodeRigidBody&)vSystem->systemData->GetCNode(cBody->GetNodeNumber(CObjectGenericODE2::ffrfNodeNumber))).GetRotationMatrix(ConfigurationType::Visualization);
			p0 = ((const CNodeRigidBody&)vSystem->systemData->GetCNode(cBody->GetNodeNumber(CObjectGenericODE2::ffrfNodeNumber))).GetPosition(ConfigurationType::Visualization);
		}
