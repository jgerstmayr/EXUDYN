...
void VisualizationObjectKinematicTree::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	...
	Transformations66List Xup; //temporary list, needs new
	Vector6DList V;
	Vector6DList Avp;
	Vector3D pos3D;
	Matrix3D rot3D;
	...
	cObject->ComputeTreeTransformations(ConfigurationType::Visualization, false, Xup, V, Avp); //Xup is the inverse transformation
...
{
	const bool drawWithTriangles = true;
...
void VisualizationObjectBeamGeometricallyExact3D::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	CObjectBeamGeometricallyExact3D* cObject = (CObjectBeamGeometricallyExact3D*)vSystem->systemData->GetCObjects()[itemNumber];

	UpdateGraphicsBeam3D(visualizationSettings, vSystem, itemNumber,
		cObject, this);
}

void VisualizationObjectANCFBeam3D::UpdateGraphics(const VisualizationSettings& visualizationSettings, VisualizationSystem* vSystem, Index itemNumber)
{
	CObjectANCFBeam3D* cObject = (CObjectANCFBeam3D*)vSystem->systemData->GetCObjects()[itemNumber];
