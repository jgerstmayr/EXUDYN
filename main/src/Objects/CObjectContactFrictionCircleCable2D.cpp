...
bool MainObjectContactFrictionCircleCable2D::CheckPreAssembleConsistency(const MainSystem& mainSystem, STDstring& errorString) const
{
	...
	{
		errorString = STDstring("ObjectContactFrictionCircleCable2D: Marker 1 must be of type = 'Cable2DShape'");
		return false;
	}
...
{
	release_assert(0 && "ERROR: illegal call to ObjectContactFrictionCircleCable2D::ComputeODE2RHSJacobian");
}
