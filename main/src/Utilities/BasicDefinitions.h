...
//#include "Autogenerated/versionCpp.h" //exclude here, in order to avoid re-compile when version changes
...
namespace EXUstd {
	...
	const float MINFLOAT = -1e38f; //!< largest negative value to be on the safe side
