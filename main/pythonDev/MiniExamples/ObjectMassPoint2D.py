...
print("start mini example for class ObjectMassPoint2D")
try: #puts example in safe environment
    ...
    print("An error occured in test example for ObjectMassPoint2D:", e)
else:
    print("example for ObjectMassPoint2D completed, test error =", testError)
