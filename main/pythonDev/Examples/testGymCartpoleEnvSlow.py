...
class CartPoleEnv():#(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    ...
    def integrateStep(self, force):
        ...
        # startTime = self.mbs.systemData.GetTime()
        # self.simulationSettings.timeIntegration.startTime = startTime 
        # self.simulationSettings.timeIntegration.endTime = startTime+self.stepUpdateTime
