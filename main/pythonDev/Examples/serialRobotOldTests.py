...
#
# Details:  OLD/DEPRECATED Example of serial robot; includes some basic robot functions and testing
#           USE serialRobotTest.py of TestModels instead!
#
...
nSteps = 200 #200 for testing
if useGraphics:
    nSteps = 550 #550 for computation of whole trajectory
    exu.StartRenderer()
...
testError = 1e-2*(VSum(measuredTorques) - 77.12176106978085) #OLDER results: up to 2021-06-28: 0.7712176106955341; 2020-08-25: 77.13193176752571 (32bits),   2020-08-24: (64bits)77.13193176846507
testResult = 1e-2*VSum(measuredTorques)   
