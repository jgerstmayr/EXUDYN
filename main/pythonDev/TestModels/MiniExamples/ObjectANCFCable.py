#+++++++++++++++++++++++++++++++++++++++++++
# Mini example for class ObjectANCFCable
#+++++++++++++++++++++++++++++++++++++++++++
...
exu.Print("start mini example for class ObjectANCFCable")
try: #puts example in safe environment
    ...
    exu.Print("An error occured in test example for ObjectANCFCable:", e)
else:
